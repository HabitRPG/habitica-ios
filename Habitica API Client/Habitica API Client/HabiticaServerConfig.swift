...
public class HabiticaServerConfig {
    ...
    public static let mobile = ServerConfiguration(scheme: "https", host: "habitica-subs.herokuapp.com", apiRoute: "api/\(Constants.defaultApiVersion)")
    public static let guilds = ServerConfiguration(scheme: "https", host: "habitica-guilds.herokuapp.com", apiRoute: "api/\(Constants.defaultApiVersion)")

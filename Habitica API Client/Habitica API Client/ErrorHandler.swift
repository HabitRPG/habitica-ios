...
public protocol NetworkErrorHandler {
    ...
    static func handle(error: NSError, message: String?)
}
...
public class PrintNetworkErrorHandler: NetworkErrorHandler {
    ...
    public static func handle(error: NSError, message: String? = nil) {

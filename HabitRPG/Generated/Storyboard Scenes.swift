...
internal enum StoryboardScene {
  ...
  internal enum Main: StoryboardType {
    ...
    internal static let subscriptionViewController = SceneType<SubscriptionViewController>(storyboard: Main.self, identifier: "SubscriptionViewController")
  ...
  internal enum Settings: StoryboardType {
    ...
    internal static let authenticationSettingsViewController = SceneType<AuthenticationSettingsViewController>(storyboard: Settings.self, identifier: "AuthenticationSettingsViewController")
  ...
  internal enum Shop: StoryboardType {
    ...
    internal static let initialScene = InitialSceneType<ShopViewController>(storyboard: Shop.self)
  }
  internal enum Social: StoryboardType {
    ...
    internal static let tavernChatViewController = SceneType<GroupChatViewController>(storyboard: Social.self, identifier: "TavernChatViewController")

    internal static let tavernNavigationViewController = SceneType<ThemedNavigationController>(storyboard: Social.self, identifier: "TavernNavigationViewController")

    internal static let tavernViewController = SceneType<TavernViewController>(storyboard: Social.self, identifier: "TavernViewController")

...
internal enum StoryboardScene {
  ...
  internal enum Stable: StoryboardType {
    ...
    internal static let initialScene = InitialSceneType<StableSplitViewController>(storyboard: Stable.self)

    internal static let mountDetailViewController = SceneType<MountDetailViewController>(storyboard: Stable.self, identifier: "MountDetailViewController")

    internal static let mountsOverviewViewController = SceneType<MountOverviewViewController>(storyboard: Stable.self, identifier: "MountsOverviewViewController")

    internal static let petDetailViewController = SceneType<PetDetailViewController>(storyboard: Stable.self, identifier: "PetDetailViewController")

    internal static let petsOverviewViewController = SceneType<PetOverviewViewController>(storyboard: Stable.self, identifier: "PetsOverviewViewController")

    internal static let stableViewController = SceneType<StableSplitViewController>(storyboard: Stable.self, identifier: "StableViewController")
  }

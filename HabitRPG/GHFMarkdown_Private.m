...
NSString *const GHFMarkdownBoldItalicRegex = @"(?:^|\\s|\\W)([*_]{3}(.+?)[*_]{3})(?:$|\\s|\\W)";
NSString *const GHFMarkdownBoldRegex = @"(?:^|\\s|\\W)([*_]{2}(.+?)[*_]{2})(?:$|\\s|\\W)";
NSString *const GHFMarkdownItalicRegex = @"(?:^|\\s|\\W)([*_]{1}(.+?)[*_]{1})(?:$|\\s|\\W)";

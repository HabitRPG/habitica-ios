...
//  Habitica
//
//  Created by Phillip Thelen on 13.04.21.
...
public class HabiticaIcons : NSObject {
    ...
    @objc dynamic public class func drawAddRemovePin(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit, addPin: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        if (addPin) {
            //// Bezier 2 Drawing
            let bezier2Path = UIBezierPath()
            bezier2Path.move(to: CGPoint(x: 5, y: 1))
            bezier2Path.addLine(to: CGPoint(x: 5, y: 7))
            pinColor.setStroke()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 14.42, y: 18.1))
        bezier3Path.addLine(to: CGPoint(x: 9.9, y: 13.58))
        bezier3Path.addLine(to: CGPoint(x: 17.57, y: 7.61))
        bezier3Path.addLine(to: CGPoint(x: 20.39, y: 10.43))
        bezier3Path.addLine(to: CGPoint(x: 14.42, y: 18.1))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 23.68, y: 10.6))
        bezier3Path.addLine(to: CGPoint(x: 22.63, y: 9.56))
        bezier3Path.addCurve(to: CGPoint(x: 22.63, y: 9.56), controlPoint1: CGPoint(x: 22.63, y: 9.56), controlPoint2: CGPoint(x: 22.63, y: 9.56))
        bezier3Path.addLine(to: CGPoint(x: 18.44, y: 5.37))
        bezier3Path.addLine(to: CGPoint(x: 17.4, y: 4.32))
        bezier3Path.addCurve(to: CGPoint(x: 15.84, y: 4.32), controlPoint1: CGPoint(x: 16.97, y: 3.89), controlPoint2: CGPoint(x: 16.27, y: 3.89))
        bezier3Path.addCurve(to: CGPoint(x: 15.84, y: 5.88), controlPoint1: CGPoint(x: 15.41, y: 4.75), controlPoint2: CGPoint(x: 15.41, y: 5.45))
        bezier3Path.addLine(to: CGPoint(x: 16, y: 6.05))
        bezier3Path.addLine(to: CGPoint(x: 8.33, y: 12.01))
        bezier3Path.addLine(to: CGPoint(x: 7.97, y: 11.65))
        bezier3Path.addCurve(to: CGPoint(x: 6.42, y: 11.65), controlPoint1: CGPoint(x: 7.54, y: 11.22), controlPoint2: CGPoint(x: 6.85, y: 11.22))
        bezier3Path.addCurve(to: CGPoint(x: 6.42, y: 13.21), controlPoint1: CGPoint(x: 5.99, y: 12.08), controlPoint2: CGPoint(x: 5.99, y: 12.78))
        bezier3Path.addLine(to: CGPoint(x: 7.46, y: 14.25))
        bezier3Path.addLine(to: CGPoint(x: 7.46, y: 14.26))
        bezier3Path.addLine(to: CGPoint(x: 9.83, y: 16.62))
        bezier3Path.addLine(to: CGPoint(x: 4.32, y: 22.12))
        bezier3Path.addCurve(to: CGPoint(x: 4.32, y: 23.68), controlPoint1: CGPoint(x: 3.89, y: 22.55), controlPoint2: CGPoint(x: 3.89, y: 23.25))
        bezier3Path.addCurve(to: CGPoint(x: 5.1, y: 24), controlPoint1: CGPoint(x: 4.54, y: 23.89), controlPoint2: CGPoint(x: 4.82, y: 24))
        bezier3Path.addCurve(to: CGPoint(x: 5.88, y: 23.68), controlPoint1: CGPoint(x: 5.38, y: 24), controlPoint2: CGPoint(x: 5.66, y: 23.89))
        bezier3Path.addLine(to: CGPoint(x: 11.38, y: 18.18))
        bezier3Path.addLine(to: CGPoint(x: 13.74, y: 20.54))
        bezier3Path.addCurve(to: CGPoint(x: 13.75, y: 20.54), controlPoint1: CGPoint(x: 13.75, y: 20.54), controlPoint2: CGPoint(x: 13.75, y: 20.54))
        bezier3Path.addLine(to: CGPoint(x: 14.79, y: 21.58))
        bezier3Path.addCurve(to: CGPoint(x: 15.57, y: 21.91), controlPoint1: CGPoint(x: 15.01, y: 21.8), controlPoint2: CGPoint(x: 15.29, y: 21.91))
        bezier3Path.addCurve(to: CGPoint(x: 16.35, y: 21.58), controlPoint1: CGPoint(x: 15.85, y: 21.91), controlPoint2: CGPoint(x: 16.13, y: 21.8))
        bezier3Path.addCurve(to: CGPoint(x: 16.35, y: 20.03), controlPoint1: CGPoint(x: 16.78, y: 21.15), controlPoint2: CGPoint(x: 16.78, y: 20.46))
        bezier3Path.addLine(to: CGPoint(x: 15.99, y: 19.67))
        bezier3Path.addLine(to: CGPoint(x: 21.96, y: 12))
        bezier3Path.addLine(to: CGPoint(x: 22.12, y: 12.16))
        bezier3Path.addCurve(to: CGPoint(x: 22.9, y: 12.48), controlPoint1: CGPoint(x: 22.34, y: 12.38), controlPoint2: CGPoint(x: 22.62, y: 12.48))
        bezier3Path.addCurve(to: CGPoint(x: 23.68, y: 12.16), controlPoint1: CGPoint(x: 23.18, y: 12.48), controlPoint2: CGPoint(x: 23.46, y: 12.38))
        bezier3Path.addCurve(to: CGPoint(x: 23.68, y: 10.6), controlPoint1: CGPoint(x: 24.11, y: 11.73), controlPoint2: CGPoint(x: 24.11, y: 11.03))
        bezier3Path.addLine(to: CGPoint(x: 23.68, y: 10.6))
        bezier3Path.close()
        bezier3Path.usesEvenOddFillRule = true
        pinColor.setFill()
        bezier3Path.fill()
    ...
    @objc dynamic public class func drawPinItem(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: 2, y: 2, width: 20, height: 20)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)
    ...
    @objc dynamic public class func drawUnpinItem(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawItemIndicator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000), isLocked: Bool = false, isLimited: Bool = false, isDark: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        if (isLocked) {
            ...
            HabiticaIcons.drawLocked(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, lockColor: lockColor)
            context.restoreGState()
        }
    ...
    @objc dynamic public class func drawItemIndicatorNumber(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground, isLocked: false, isLimited: false, isDark: false)
        context.restoreGState()
    ...
    @objc dynamic public class func drawItemIndicatorLocked(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground, isLocked: true, isLimited: false, isDark: false)
        context.restoreGState()
    ...
    @objc dynamic public class func drawItemIndicatorLimited(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground, isLocked: false, isLimited: true, isDark: false)
        context.restoreGState()
    ...
    @objc dynamic public class func drawLocked(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 17), resizing: ResizingBehavior = .aspectFit, lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawGuildHeaderCrest(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 116, height: 58), resizing: ResizingBehavior = .aspectFit, guildHeader: UIColor = UIColor(red: 0.310, green: 0.165, blue: 0.576, alpha: 1.000)) {
        ...
        //// Label 2 Drawing
        let label2Path = UIBezierPath()
        label2Path.move(to: CGPoint(x: 42.98, y: 35.93))
        label2Path.addLine(to: CGPoint(x: 43.28, y: 37))
        label2Path.addLine(to: CGPoint(x: 44, y: 37))
        label2Path.addLine(to: CGPoint(x: 44, y: 32.49))
        label2Path.addLine(to: CGPoint(x: 40.24, y: 32.49))
        label2Path.addLine(to: CGPoint(x: 40.24, y: 33.45))
        label2Path.addLine(to: CGPoint(x: 42.98, y: 33.45))
        label2Path.addCurve(to: CGPoint(x: 42.82, y: 34.55), controlPoint1: CGPoint(x: 42.99, y: 33.84), controlPoint2: CGPoint(x: 42.94, y: 34.21))
        label2Path.addCurve(to: CGPoint(x: 42.29, y: 35.43), controlPoint1: CGPoint(x: 42.7, y: 34.89), controlPoint2: CGPoint(x: 42.52, y: 35.18))
        label2Path.addCurve(to: CGPoint(x: 41.42, y: 36.03), controlPoint1: CGPoint(x: 42.05, y: 35.69), controlPoint2: CGPoint(x: 41.76, y: 35.88))
        label2Path.addCurve(to: CGPoint(x: 40.23, y: 36.24), controlPoint1: CGPoint(x: 41.07, y: 36.17), controlPoint2: CGPoint(x: 40.68, y: 36.24))
        label2Path.addCurve(to: CGPoint(x: 38.96, y: 35.96), controlPoint1: CGPoint(x: 39.75, y: 36.24), controlPoint2: CGPoint(x: 39.33, y: 36.15))
        label2Path.addCurve(to: CGPoint(x: 38.04, y: 35.21), controlPoint1: CGPoint(x: 38.6, y: 35.77), controlPoint2: CGPoint(x: 38.29, y: 35.52))
        label2Path.addCurve(to: CGPoint(x: 37.48, y: 34.11), controlPoint1: CGPoint(x: 37.8, y: 34.89), controlPoint2: CGPoint(x: 37.61, y: 34.53))
        label2Path.addCurve(to: CGPoint(x: 37.29, y: 32.82), controlPoint1: CGPoint(x: 37.35, y: 33.7), controlPoint2: CGPoint(x: 37.29, y: 33.27))
        label2Path.addCurve(to: CGPoint(x: 37.46, y: 31.49), controlPoint1: CGPoint(x: 37.29, y: 32.37), controlPoint2: CGPoint(x: 37.34, y: 31.92))
        label2Path.addCurve(to: CGPoint(x: 37.98, y: 30.32), controlPoint1: CGPoint(x: 37.57, y: 31.05), controlPoint2: CGPoint(x: 37.74, y: 30.66))
        label2Path.addCurve(to: CGPoint(x: 38.89, y: 29.5), controlPoint1: CGPoint(x: 38.21, y: 29.98), controlPoint2: CGPoint(x: 38.52, y: 29.71))
        label2Path.addCurve(to: CGPoint(x: 40.23, y: 29.19), controlPoint1: CGPoint(x: 39.26, y: 29.29), controlPoint2: CGPoint(x: 39.71, y: 29.19))
        label2Path.addCurve(to: CGPoint(x: 41.13, y: 29.3), controlPoint1: CGPoint(x: 40.55, y: 29.19), controlPoint2: CGPoint(x: 40.85, y: 29.23))
        label2Path.addCurve(to: CGPoint(x: 41.9, y: 29.64), controlPoint1: CGPoint(x: 41.42, y: 29.38), controlPoint2: CGPoint(x: 41.67, y: 29.49))
        label2Path.addCurve(to: CGPoint(x: 42.46, y: 30.23), controlPoint1: CGPoint(x: 42.12, y: 29.8), controlPoint2: CGPoint(x: 42.31, y: 29.99))
        label2Path.addCurve(to: CGPoint(x: 42.77, y: 31.07), controlPoint1: CGPoint(x: 42.61, y: 30.46), controlPoint2: CGPoint(x: 42.72, y: 30.74))
        label2Path.addLine(to: CGPoint(x: 43.91, y: 31.07))
        label2Path.addCurve(to: CGPoint(x: 43.46, y: 29.78), controlPoint1: CGPoint(x: 43.83, y: 30.57), controlPoint2: CGPoint(x: 43.68, y: 30.14))
        label2Path.addCurve(to: CGPoint(x: 42.65, y: 28.9), controlPoint1: CGPoint(x: 43.24, y: 29.43), controlPoint2: CGPoint(x: 42.97, y: 29.13))
        label2Path.addCurve(to: CGPoint(x: 41.54, y: 28.39), controlPoint1: CGPoint(x: 42.32, y: 28.67), controlPoint2: CGPoint(x: 41.95, y: 28.5))
        label2Path.addCurve(to: CGPoint(x: 40.23, y: 28.23), controlPoint1: CGPoint(x: 41.13, y: 28.28), controlPoint2: CGPoint(x: 40.69, y: 28.23))
        label2Path.addCurve(to: CGPoint(x: 38.45, y: 28.61), controlPoint1: CGPoint(x: 39.55, y: 28.23), controlPoint2: CGPoint(x: 38.95, y: 28.35))
        label2Path.addCurve(to: CGPoint(x: 37.17, y: 29.62), controlPoint1: CGPoint(x: 37.94, y: 28.86), controlPoint2: CGPoint(x: 37.51, y: 29.2))
        label2Path.addCurve(to: CGPoint(x: 36.41, y: 31.1), controlPoint1: CGPoint(x: 36.83, y: 30.04), controlPoint2: CGPoint(x: 36.58, y: 30.54))
        label2Path.addCurve(to: CGPoint(x: 36.15, y: 32.88), controlPoint1: CGPoint(x: 36.23, y: 31.67), controlPoint2: CGPoint(x: 36.15, y: 32.26))
        label2Path.addCurve(to: CGPoint(x: 36.42, y: 34.5), controlPoint1: CGPoint(x: 36.15, y: 33.44), controlPoint2: CGPoint(x: 36.24, y: 33.98))
        label2Path.addCurve(to: CGPoint(x: 37.23, y: 35.88), controlPoint1: CGPoint(x: 36.61, y: 35.02), controlPoint2: CGPoint(x: 36.88, y: 35.48))
        label2Path.addCurve(to: CGPoint(x: 38.51, y: 36.84), controlPoint1: CGPoint(x: 37.58, y: 36.28), controlPoint2: CGPoint(x: 38.01, y: 36.6))
        label2Path.addCurve(to: CGPoint(x: 40.23, y: 37.19), controlPoint1: CGPoint(x: 39.02, y: 37.07), controlPoint2: CGPoint(x: 39.59, y: 37.19))
        label2Path.addCurve(to: CGPoint(x: 41.73, y: 36.9), controlPoint1: CGPoint(x: 40.73, y: 37.19), controlPoint2: CGPoint(x: 41.23, y: 37.09))
        label2Path.addCurve(to: CGPoint(x: 42.98, y: 35.93), controlPoint1: CGPoint(x: 42.22, y: 36.7), controlPoint2: CGPoint(x: 42.64, y: 36.38))
        label2Path.close()
        label2Path.move(to: CGPoint(x: 52.52, y: 33.9))
        label2Path.addLine(to: CGPoint(x: 52.52, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 51.38, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 51.38, y: 33.9))
        label2Path.addCurve(to: CGPoint(x: 50.81, y: 35.65), controlPoint1: CGPoint(x: 51.38, y: 34.67), controlPoint2: CGPoint(x: 51.19, y: 35.25))
        label2Path.addCurve(to: CGPoint(x: 49.14, y: 36.24), controlPoint1: CGPoint(x: 50.43, y: 36.05), controlPoint2: CGPoint(x: 49.87, y: 36.24))
        label2Path.addCurve(to: CGPoint(x: 47.38, y: 35.65), controlPoint1: CGPoint(x: 48.38, y: 36.24), controlPoint2: CGPoint(x: 47.79, y: 36.05))
        label2Path.addCurve(to: CGPoint(x: 46.77, y: 33.9), controlPoint1: CGPoint(x: 46.97, y: 35.25), controlPoint2: CGPoint(x: 46.77, y: 34.67))
        label2Path.addLine(to: CGPoint(x: 46.77, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 45.63, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 45.63, y: 33.9))
        label2Path.addCurve(to: CGPoint(x: 46.56, y: 36.41), controlPoint1: CGPoint(x: 45.63, y: 35.05), controlPoint2: CGPoint(x: 45.94, y: 35.88))
        label2Path.addCurve(to: CGPoint(x: 49.14, y: 37.19), controlPoint1: CGPoint(x: 47.18, y: 36.93), controlPoint2: CGPoint(x: 48.04, y: 37.19))
        label2Path.addCurve(to: CGPoint(x: 51.64, y: 36.37), controlPoint1: CGPoint(x: 50.22, y: 37.19), controlPoint2: CGPoint(x: 51.06, y: 36.92))
        label2Path.addCurve(to: CGPoint(x: 52.52, y: 33.9), controlPoint1: CGPoint(x: 52.22, y: 35.82), controlPoint2: CGPoint(x: 52.52, y: 35))
        label2Path.close()
        label2Path.move(to: CGPoint(x: 54.39, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 54.39, y: 37))
        label2Path.addLine(to: CGPoint(x: 55.53, y: 37))
        label2Path.addLine(to: CGPoint(x: 55.53, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 54.39, y: 28.43))
        label2Path.close()
        label2Path.move(to: CGPoint(x: 57.45, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 57.45, y: 37))
        label2Path.addLine(to: CGPoint(x: 63.12, y: 37))
        label2Path.addLine(to: CGPoint(x: 63.12, y: 36.04))
        label2Path.addLine(to: CGPoint(x: 58.59, y: 36.04))
        label2Path.addLine(to: CGPoint(x: 58.59, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 57.45, y: 28.43))
        label2Path.close()
        label2Path.move(to: CGPoint(x: 65.26, y: 36.04))
        label2Path.addLine(to: CGPoint(x: 65.26, y: 29.39))
        label2Path.addLine(to: CGPoint(x: 67.18, y: 29.39))
        label2Path.addCurve(to: CGPoint(x: 68.51, y: 29.61), controlPoint1: CGPoint(x: 67.71, y: 29.39), controlPoint2: CGPoint(x: 68.15, y: 29.47))
        label2Path.addCurve(to: CGPoint(x: 69.39, y: 30.26), controlPoint1: CGPoint(x: 68.87, y: 29.76), controlPoint2: CGPoint(x: 69.17, y: 29.98))
        label2Path.addCurve(to: CGPoint(x: 69.89, y: 31.29), controlPoint1: CGPoint(x: 69.62, y: 30.55), controlPoint2: CGPoint(x: 69.79, y: 30.89))
        label2Path.addCurve(to: CGPoint(x: 70.04, y: 32.67), controlPoint1: CGPoint(x: 69.99, y: 31.7), controlPoint2: CGPoint(x: 70.04, y: 32.16))
        label2Path.addCurve(to: CGPoint(x: 69.87, y: 34.02), controlPoint1: CGPoint(x: 70.04, y: 33.2), controlPoint2: CGPoint(x: 69.98, y: 33.65))
        label2Path.addCurve(to: CGPoint(x: 69.46, y: 34.95), controlPoint1: CGPoint(x: 69.77, y: 34.39), controlPoint2: CGPoint(x: 69.63, y: 34.7))
        label2Path.addCurve(to: CGPoint(x: 68.89, y: 35.54), controlPoint1: CGPoint(x: 69.29, y: 35.2), controlPoint2: CGPoint(x: 69.1, y: 35.39))
        label2Path.addCurve(to: CGPoint(x: 68.25, y: 35.87), controlPoint1: CGPoint(x: 68.68, y: 35.68), controlPoint2: CGPoint(x: 68.46, y: 35.79))
        label2Path.addCurve(to: CGPoint(x: 67.64, y: 36.01), controlPoint1: CGPoint(x: 68.03, y: 35.94), controlPoint2: CGPoint(x: 67.83, y: 35.99))
        label2Path.addCurve(to: CGPoint(x: 67.16, y: 36.04), controlPoint1: CGPoint(x: 67.44, y: 36.03), controlPoint2: CGPoint(x: 67.28, y: 36.04))
        label2Path.addLine(to: CGPoint(x: 65.26, y: 36.04))
        label2Path.close()
        label2Path.move(to: CGPoint(x: 64.12, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 64.12, y: 37))
        label2Path.addLine(to: CGPoint(x: 67.06, y: 37))
        label2Path.addCurve(to: CGPoint(x: 68.91, y: 36.7), controlPoint1: CGPoint(x: 67.77, y: 37), controlPoint2: CGPoint(x: 68.39, y: 36.9))
        label2Path.addCurve(to: CGPoint(x: 70.19, y: 35.83), controlPoint1: CGPoint(x: 69.43, y: 36.5), controlPoint2: CGPoint(x: 69.86, y: 36.21))
        label2Path.addCurve(to: CGPoint(x: 70.94, y: 34.43), controlPoint1: CGPoint(x: 70.53, y: 35.45), controlPoint2: CGPoint(x: 70.78, y: 34.98))
        label2Path.addCurve(to: CGPoint(x: 71.18, y: 32.51), controlPoint1: CGPoint(x: 71.1, y: 33.87), controlPoint2: CGPoint(x: 71.18, y: 33.23))
        label2Path.addCurve(to: CGPoint(x: 70.11, y: 29.44), controlPoint1: CGPoint(x: 71.18, y: 31.14), controlPoint2: CGPoint(x: 70.82, y: 30.11))
        label2Path.addCurve(to: CGPoint(x: 67.06, y: 28.43), controlPoint1: CGPoint(x: 69.4, y: 28.77), controlPoint2: CGPoint(x: 68.38, y: 28.43))
        label2Path.addLine(to: CGPoint(x: 64.12, y: 28.43))
        label2Path.close()
        label2Path.move(to: CGPoint(x: 77.52, y: 30.94))
        label2Path.addLine(to: CGPoint(x: 78.6, y: 30.94))
        label2Path.addCurve(to: CGPoint(x: 78.33, y: 29.72), controlPoint1: CGPoint(x: 78.59, y: 30.47), controlPoint2: CGPoint(x: 78.5, y: 30.06))
        label2Path.addCurve(to: CGPoint(x: 77.66, y: 28.88), controlPoint1: CGPoint(x: 78.17, y: 29.38), controlPoint2: CGPoint(x: 77.95, y: 29.1))
        label2Path.addCurve(to: CGPoint(x: 76.67, y: 28.38), controlPoint1: CGPoint(x: 77.38, y: 28.65), controlPoint2: CGPoint(x: 77.05, y: 28.49))
        label2Path.addCurve(to: CGPoint(x: 75.45, y: 28.23), controlPoint1: CGPoint(x: 76.3, y: 28.28), controlPoint2: CGPoint(x: 75.89, y: 28.23))
        label2Path.addCurve(to: CGPoint(x: 74.3, y: 28.38), controlPoint1: CGPoint(x: 75.06, y: 28.23), controlPoint2: CGPoint(x: 74.67, y: 28.28))
        label2Path.addCurve(to: CGPoint(x: 73.31, y: 28.83), controlPoint1: CGPoint(x: 73.93, y: 28.48), controlPoint2: CGPoint(x: 73.6, y: 28.63))
        label2Path.addCurve(to: CGPoint(x: 72.6, y: 29.61), controlPoint1: CGPoint(x: 73.01, y: 29.04), controlPoint2: CGPoint(x: 72.78, y: 29.3))
        label2Path.addCurve(to: CGPoint(x: 72.34, y: 30.74), controlPoint1: CGPoint(x: 72.43, y: 29.93), controlPoint2: CGPoint(x: 72.34, y: 30.3))
        label2Path.addCurve(to: CGPoint(x: 72.57, y: 31.71), controlPoint1: CGPoint(x: 72.34, y: 31.13), controlPoint2: CGPoint(x: 72.42, y: 31.45))
        label2Path.addCurve(to: CGPoint(x: 73.2, y: 32.35), controlPoint1: CGPoint(x: 72.73, y: 31.97), controlPoint2: CGPoint(x: 72.94, y: 32.19))
        label2Path.addCurve(to: CGPoint(x: 74.08, y: 32.75), controlPoint1: CGPoint(x: 73.46, y: 32.51), controlPoint2: CGPoint(x: 73.75, y: 32.65))
        label2Path.addCurve(to: CGPoint(x: 75.08, y: 33.01), controlPoint1: CGPoint(x: 74.41, y: 32.85), controlPoint2: CGPoint(x: 74.74, y: 32.93))
        label2Path.addCurve(to: CGPoint(x: 76.08, y: 33.23), controlPoint1: CGPoint(x: 75.42, y: 33.09), controlPoint2: CGPoint(x: 75.76, y: 33.16))
        label2Path.addCurve(to: CGPoint(x: 76.97, y: 33.51), controlPoint1: CGPoint(x: 76.41, y: 33.3), controlPoint2: CGPoint(x: 76.71, y: 33.4))
        label2Path.addCurve(to: CGPoint(x: 77.59, y: 33.96), controlPoint1: CGPoint(x: 77.23, y: 33.63), controlPoint2: CGPoint(x: 77.43, y: 33.78))
        label2Path.addCurve(to: CGPoint(x: 77.82, y: 34.68), controlPoint1: CGPoint(x: 77.75, y: 34.15), controlPoint2: CGPoint(x: 77.82, y: 34.39))
        label2Path.addCurve(to: CGPoint(x: 77.63, y: 35.45), controlPoint1: CGPoint(x: 77.82, y: 35), controlPoint2: CGPoint(x: 77.76, y: 35.25))
        label2Path.addCurve(to: CGPoint(x: 77.13, y: 35.93), controlPoint1: CGPoint(x: 77.5, y: 35.65), controlPoint2: CGPoint(x: 77.34, y: 35.81))
        label2Path.addCurve(to: CGPoint(x: 76.43, y: 36.17), controlPoint1: CGPoint(x: 76.92, y: 36.04), controlPoint2: CGPoint(x: 76.69, y: 36.12))
        label2Path.addCurve(to: CGPoint(x: 75.65, y: 36.24), controlPoint1: CGPoint(x: 76.17, y: 36.22), controlPoint2: CGPoint(x: 75.91, y: 36.24))
        label2Path.addCurve(to: CGPoint(x: 74.72, y: 36.12), controlPoint1: CGPoint(x: 75.33, y: 36.24), controlPoint2: CGPoint(x: 75.02, y: 36.2))
        label2Path.addCurve(to: CGPoint(x: 73.92, y: 35.75), controlPoint1: CGPoint(x: 74.41, y: 36.04), controlPoint2: CGPoint(x: 74.15, y: 35.92))
        label2Path.addCurve(to: CGPoint(x: 73.37, y: 35.11), controlPoint1: CGPoint(x: 73.69, y: 35.58), controlPoint2: CGPoint(x: 73.51, y: 35.37))
        label2Path.addCurve(to: CGPoint(x: 73.16, y: 34.18), controlPoint1: CGPoint(x: 73.23, y: 34.85), controlPoint2: CGPoint(x: 73.16, y: 34.54))
        label2Path.addLine(to: CGPoint(x: 72.08, y: 34.18))
        label2Path.addCurve(to: CGPoint(x: 72.36, y: 35.53), controlPoint1: CGPoint(x: 72.08, y: 34.7), controlPoint2: CGPoint(x: 72.17, y: 35.15))
        label2Path.addCurve(to: CGPoint(x: 73.13, y: 36.47), controlPoint1: CGPoint(x: 72.55, y: 35.91), controlPoint2: CGPoint(x: 72.8, y: 36.22))
        label2Path.addCurve(to: CGPoint(x: 74.25, y: 37.01), controlPoint1: CGPoint(x: 73.45, y: 36.71), controlPoint2: CGPoint(x: 73.83, y: 36.89))
        label2Path.addCurve(to: CGPoint(x: 75.62, y: 37.19), controlPoint1: CGPoint(x: 74.68, y: 37.13), controlPoint2: CGPoint(x: 75.14, y: 37.19))
        label2Path.addCurve(to: CGPoint(x: 76.8, y: 37.05), controlPoint1: CGPoint(x: 76.01, y: 37.19), controlPoint2: CGPoint(x: 76.4, y: 37.15))
        label2Path.addCurve(to: CGPoint(x: 77.87, y: 36.61), controlPoint1: CGPoint(x: 77.19, y: 36.96), controlPoint2: CGPoint(x: 77.55, y: 36.81))
        label2Path.addCurve(to: CGPoint(x: 78.66, y: 35.82), controlPoint1: CGPoint(x: 78.19, y: 36.41), controlPoint2: CGPoint(x: 78.45, y: 36.14))
        label2Path.addCurve(to: CGPoint(x: 78.96, y: 34.65), controlPoint1: CGPoint(x: 78.86, y: 35.49), controlPoint2: CGPoint(x: 78.96, y: 35.1))
        label2Path.addCurve(to: CGPoint(x: 78.73, y: 33.59), controlPoint1: CGPoint(x: 78.96, y: 34.22), controlPoint2: CGPoint(x: 78.89, y: 33.87))
        label2Path.addCurve(to: CGPoint(x: 78.11, y: 32.9), controlPoint1: CGPoint(x: 78.57, y: 33.31), controlPoint2: CGPoint(x: 78.37, y: 33.08))
        label2Path.addCurve(to: CGPoint(x: 77.22, y: 32.46), controlPoint1: CGPoint(x: 77.85, y: 32.71), controlPoint2: CGPoint(x: 77.55, y: 32.57))
        label2Path.addCurve(to: CGPoint(x: 76.22, y: 32.18), controlPoint1: CGPoint(x: 76.9, y: 32.35), controlPoint2: CGPoint(x: 76.56, y: 32.26))
        label2Path.addCurve(to: CGPoint(x: 75.22, y: 31.95), controlPoint1: CGPoint(x: 75.88, y: 32.1), controlPoint2: CGPoint(x: 75.55, y: 32.02))
        label2Path.addCurve(to: CGPoint(x: 74.34, y: 31.7), controlPoint1: CGPoint(x: 74.89, y: 31.89), controlPoint2: CGPoint(x: 74.6, y: 31.8))
        label2Path.addCurve(to: CGPoint(x: 73.71, y: 31.29), controlPoint1: CGPoint(x: 74.08, y: 31.59), controlPoint2: CGPoint(x: 73.87, y: 31.46))
        label2Path.addCurve(to: CGPoint(x: 73.48, y: 30.65), controlPoint1: CGPoint(x: 73.56, y: 31.13), controlPoint2: CGPoint(x: 73.48, y: 30.92))
        label2Path.addCurve(to: CGPoint(x: 73.64, y: 29.95), controlPoint1: CGPoint(x: 73.48, y: 30.37), controlPoint2: CGPoint(x: 73.53, y: 30.14))
        label2Path.addCurve(to: CGPoint(x: 74.07, y: 29.5), controlPoint1: CGPoint(x: 73.75, y: 29.76), controlPoint2: CGPoint(x: 73.89, y: 29.61))
        label2Path.addCurve(to: CGPoint(x: 74.69, y: 29.26), controlPoint1: CGPoint(x: 74.25, y: 29.39), controlPoint2: CGPoint(x: 74.46, y: 29.31))
        label2Path.addCurve(to: CGPoint(x: 75.4, y: 29.19), controlPoint1: CGPoint(x: 74.92, y: 29.21), controlPoint2: CGPoint(x: 75.16, y: 29.19))
        label2Path.addCurve(to: CGPoint(x: 76.86, y: 29.6), controlPoint1: CGPoint(x: 75.99, y: 29.19), controlPoint2: CGPoint(x: 76.48, y: 29.33))
        label2Path.addCurve(to: CGPoint(x: 77.52, y: 30.94), controlPoint1: CGPoint(x: 77.24, y: 29.88), controlPoint2: CGPoint(x: 77.46, y: 30.32))
        label2Path.close()
    ...
    @objc dynamic public class func drawParticipantsIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 20, height: 20), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let fillColor25 = UIColor(red: 0.882, green: 0.878, blue: 0.890, alpha: 1.000)
        let fillColor39 = UIColor(red: 0.741, green: 0.659, blue: 1.000, alpha: 1.000)
        let fillColor104 = UIColor(red: 0.976, green: 0.976, blue: 0.976, alpha: 1.000)

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 5, y: 3))
        bezierPath.addLine(to: CGPoint(x: 3, y: 7))
        ...
        bezierPath.addLine(to: CGPoint(x: 11, y: 8))
        bezierPath.addLine(to: CGPoint(x: 11, y: 4))
        bezierPath.addLine(to: CGPoint(x: 10, y: 4))
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 15, y: 3))
        bezier2Path.addLine(to: CGPoint(x: 17, y: 5))
        bezier2Path.addLine(to: CGPoint(x: 17, y: 9))
        bezier2Path.addLine(to: CGPoint(x: 15, y: 11))
        bezier2Path.addLine(to: CGPoint(x: 18, y: 13))
        bezier2Path.addLine(to: CGPoint(x: 19, y: 15))
        bezier2Path.addLine(to: CGPoint(x: 19, y: 17))
        bezier2Path.addLine(to: CGPoint(x: 13, y: 17))
        bezier2Path.addLine(to: CGPoint(x: 13, y: 14))
        bezier2Path.addLine(to: CGPoint(x: 11, y: 12))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 10))
        bezier2Path.addLine(to: CGPoint(x: 11, y: 7))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 4))
        bezier2Path.addLine(to: CGPoint(x: 13, y: 3))
        bezier2Path.addLine(to: CGPoint(x: 15, y: 3))
        bezier2Path.close()
        bezier2Path.usesEvenOddFillRule = true
        fillColor25.setFill()
        bezier2Path.fill()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 14, y: 16))
        bezier3Path.addCurve(to: CGPoint(x: 12.46, y: 12), controlPoint1: CGPoint(x: 14, y: 14.46), controlPoint2: CGPoint(x: 13.42, y: 13.06))
        bezier3Path.addLine(to: CGPoint(x: 14, y: 12))
        bezier3Path.addCurve(to: CGPoint(x: 18, y: 16), controlPoint1: CGPoint(x: 16.21, y: 12), controlPoint2: CGPoint(x: 18, y: 13.79))
        bezier3Path.addLine(to: CGPoint(x: 14, y: 16))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 2, y: 16))
        bezier3Path.addCurve(to: CGPoint(x: 6, y: 12), controlPoint1: CGPoint(x: 2, y: 13.79), controlPoint2: CGPoint(x: 3.79, y: 12))
        bezier3Path.addLine(to: CGPoint(x: 8, y: 12))
        bezier3Path.addCurve(to: CGPoint(x: 12, y: 16), controlPoint1: CGPoint(x: 10.21, y: 12), controlPoint2: CGPoint(x: 12, y: 13.79))
        bezier3Path.addLine(to: CGPoint(x: 2, y: 16))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 7, y: 4))
        bezier3Path.addCurve(to: CGPoint(x: 10, y: 7), controlPoint1: CGPoint(x: 8.66, y: 4), controlPoint2: CGPoint(x: 10, y: 5.34))
        bezier3Path.addCurve(to: CGPoint(x: 7, y: 10), controlPoint1: CGPoint(x: 10, y: 8.66), controlPoint2: CGPoint(x: 8.66, y: 10))
        bezier3Path.addCurve(to: CGPoint(x: 4, y: 7), controlPoint1: CGPoint(x: 5.34, y: 10), controlPoint2: CGPoint(x: 4, y: 8.66))
        bezier3Path.addCurve(to: CGPoint(x: 7, y: 4), controlPoint1: CGPoint(x: 4, y: 5.34), controlPoint2: CGPoint(x: 5.34, y: 4))
        bezier3Path.addLine(to: CGPoint(x: 7, y: 4))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 11.31, y: 4.52))
        bezier3Path.addCurve(to: CGPoint(x: 13, y: 4), controlPoint1: CGPoint(x: 11.79, y: 4.19), controlPoint2: CGPoint(x: 12.38, y: 4))
        bezier3Path.addCurve(to: CGPoint(x: 16, y: 7), controlPoint1: CGPoint(x: 14.66, y: 4), controlPoint2: CGPoint(x: 16, y: 5.34))
        bezier3Path.addCurve(to: CGPoint(x: 13, y: 10), controlPoint1: CGPoint(x: 16, y: 8.66), controlPoint2: CGPoint(x: 14.66, y: 10))
        bezier3Path.addCurve(to: CGPoint(x: 11.31, y: 9.48), controlPoint1: CGPoint(x: 12.38, y: 10), controlPoint2: CGPoint(x: 11.79, y: 9.81))
        bezier3Path.addCurve(to: CGPoint(x: 12, y: 7), controlPoint1: CGPoint(x: 11.74, y: 8.75), controlPoint2: CGPoint(x: 12, y: 7.91))
        bezier3Path.addCurve(to: CGPoint(x: 11.31, y: 4.52), controlPoint1: CGPoint(x: 12, y: 6.09), controlPoint2: CGPoint(x: 11.74, y: 5.25))
        bezier3Path.addLine(to: CGPoint(x: 11.31, y: 4.52))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 16.51, y: 10.56))
        bezier3Path.addCurve(to: CGPoint(x: 18, y: 7), controlPoint1: CGPoint(x: 17.43, y: 9.65), controlPoint2: CGPoint(x: 18, y: 8.39))
        bezier3Path.addCurve(to: CGPoint(x: 13, y: 2), controlPoint1: CGPoint(x: 18, y: 4.24), controlPoint2: CGPoint(x: 15.76, y: 2))
        bezier3Path.addCurve(to: CGPoint(x: 10, y: 3.03), controlPoint1: CGPoint(x: 11.87, y: 2), controlPoint2: CGPoint(x: 10.84, y: 2.39))
        bezier3Path.addCurve(to: CGPoint(x: 7, y: 2), controlPoint1: CGPoint(x: 9.16, y: 2.39), controlPoint2: CGPoint(x: 8.13, y: 2))
        bezier3Path.addCurve(to: CGPoint(x: 2, y: 7), controlPoint1: CGPoint(x: 4.24, y: 2), controlPoint2: CGPoint(x: 2, y: 4.24))
        bezier3Path.addCurve(to: CGPoint(x: 3.49, y: 10.56), controlPoint1: CGPoint(x: 2, y: 8.39), controlPoint2: CGPoint(x: 2.57, y: 9.65))
        bezier3Path.addCurve(to: CGPoint(x: 0, y: 16), controlPoint1: CGPoint(x: 1.43, y: 11.51), controlPoint2: CGPoint(x: 0, y: 13.58))
        bezier3Path.addCurve(to: CGPoint(x: 2, y: 18), controlPoint1: CGPoint(x: 0, y: 17.11), controlPoint2: CGPoint(x: 0.9, y: 18))
        bezier3Path.addLine(to: CGPoint(x: 8, y: 18))
        bezier3Path.addLine(to: CGPoint(x: 12, y: 18))
        bezier3Path.addLine(to: CGPoint(x: 18, y: 18))
        bezier3Path.addCurve(to: CGPoint(x: 20, y: 16), controlPoint1: CGPoint(x: 19.11, y: 18), controlPoint2: CGPoint(x: 20, y: 17.11))
        bezier3Path.addCurve(to: CGPoint(x: 16.51, y: 10.56), controlPoint1: CGPoint(x: 20, y: 13.58), controlPoint2: CGPoint(x: 18.57, y: 11.51))
        bezier3Path.addLine(to: CGPoint(x: 16.51, y: 10.56))
        bezier3Path.close()
        bezier3Path.usesEvenOddFillRule = true
        fillColor39.setFill()
        bezier3Path.fill()
    ...
    @objc dynamic public class func drawChatReplyIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 17, height: 17), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 17, height: 17), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 17, y: resizedFrame.height / 17)
        ...
        //// Clip Clip
        let clipPath = UIBezierPath()
        clipPath.move(to: CGPoint(x: -10, y: -9))
        clipPath.addLine(to: CGPoint(x: 27, y: -9))
        clipPath.addLine(to: CGPoint(x: 27, y: 26))
        clipPath.addLine(to: CGPoint(x: -10, y: 26))
        clipPath.addLine(to: CGPoint(x: -10, y: -9))
        clipPath.close()
        clipPath.move(to: CGPoint(x: 6.54, y: 3))
        clipPath.addLine(to: CGPoint(x: 2, y: 7.58))
        clipPath.addLine(to: CGPoint(x: 6.54, y: 12.16))
        clipPath.addLine(to: CGPoint(x: 6.54, y: 8.72))
        clipPath.addCurve(to: CGPoint(x: 14.9, y: 14), controlPoint1: CGPoint(x: 11.46, y: 8.24), controlPoint2: CGPoint(x: 14.24, y: 10))
        clipPath.addCurve(to: CGPoint(x: 6.54, y: 6.44), controlPoint1: CGPoint(x: 15.57, y: 8.67), controlPoint2: CGPoint(x: 12.78, y: 6.15))
        clipPath.addLine(to: CGPoint(x: 6.54, y: 3))
        clipPath.close()
        clipPath.usesEvenOddFillRule = true
        clipPath.addClip()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 6.54, y: 3))
        bezierPath.addLine(to: CGPoint(x: 2, y: 7.58))
        bezierPath.addLine(to: CGPoint(x: 6.54, y: 12.16))
        bezierPath.addLine(to: CGPoint(x: 6.54, y: 8.72))
        bezierPath.addCurve(to: CGPoint(x: 14.9, y: 14), controlPoint1: CGPoint(x: 11.46, y: 8.24), controlPoint2: CGPoint(x: 14.24, y: 10))
        bezierPath.addCurve(to: CGPoint(x: 6.54, y: 6.44), controlPoint1: CGPoint(x: 15.57, y: 8.67), controlPoint2: CGPoint(x: 12.78, y: 6.15))
        bezierPath.addLine(to: CGPoint(x: 6.54, y: 3))
        bezierPath.close()
    ...
    @objc dynamic public class func drawChatCopyIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 17, height: 17), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 6, y: 15))
        bezierPath.addLine(to: CGPoint(x: 14, y: 15))
        bezierPath.addLine(to: CGPoint(x: 14, y: 5))
        bezierPath.addLine(to: CGPoint(x: 6, y: 5))
        bezierPath.addLine(to: CGPoint(x: 6, y: 15))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 2, y: 13))
        bezierPath.addLine(to: CGPoint(x: 2, y: 3))
        bezierPath.addLine(to: CGPoint(x: 6, y: 3))
        bezierPath.addCurve(to: CGPoint(x: 4, y: 5), controlPoint1: CGPoint(x: 4.9, y: 3), controlPoint2: CGPoint(x: 4, y: 3.89))
        bezierPath.addLine(to: CGPoint(x: 4, y: 13))
        bezierPath.addLine(to: CGPoint(x: 2, y: 13))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 14, y: 3))
        bezierPath.addLine(to: CGPoint(x: 12, y: 3))
        bezierPath.addCurve(to: CGPoint(x: 10, y: 1), controlPoint1: CGPoint(x: 12, y: 1.89), controlPoint2: CGPoint(x: 11.11, y: 1))
        bezierPath.addLine(to: CGPoint(x: 2, y: 1))
        bezierPath.addCurve(to: CGPoint(x: 0, y: 3), controlPoint1: CGPoint(x: 0.9, y: 1), controlPoint2: CGPoint(x: 0, y: 1.89))
        bezierPath.addLine(to: CGPoint(x: 0, y: 13))
        bezierPath.addCurve(to: CGPoint(x: 2, y: 15), controlPoint1: CGPoint(x: 0, y: 14.11), controlPoint2: CGPoint(x: 0.9, y: 15))
        bezierPath.addLine(to: CGPoint(x: 4, y: 15))
        bezierPath.addCurve(to: CGPoint(x: 6, y: 17), controlPoint1: CGPoint(x: 4, y: 16.11), controlPoint2: CGPoint(x: 4.9, y: 17))
        bezierPath.addLine(to: CGPoint(x: 14, y: 17))
        bezierPath.addCurve(to: CGPoint(x: 16, y: 15), controlPoint1: CGPoint(x: 15.11, y: 17), controlPoint2: CGPoint(x: 16, y: 16.11))
        bezierPath.addLine(to: CGPoint(x: 16, y: 5))
        bezierPath.addCurve(to: CGPoint(x: 14, y: 3), controlPoint1: CGPoint(x: 16, y: 3.89), controlPoint2: CGPoint(x: 15.11, y: 3))
    ...
    @objc dynamic public class func drawChatReportIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 17, height: 18), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 17, height: 18), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 17, y: resizedFrame.height / 18)
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 6, y: 13))
        ...
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 4, y: 10))
        bezierPath.addLine(to: CGPoint(x: 2, y: 10))
        bezierPath.addLine(to: CGPoint(x: 2, y: 4))
        bezierPath.addLine(to: CGPoint(x: 9, y: 4))
        bezierPath.addLine(to: CGPoint(x: 9, y: 5))
        bezierPath.addLine(to: CGPoint(x: 6, y: 5))
        bezierPath.addCurve(to: CGPoint(x: 4, y: 7), controlPoint1: CGPoint(x: 4.9, y: 5), controlPoint2: CGPoint(x: 4, y: 5.89))
        bezierPath.addLine(to: CGPoint(x: 4, y: 10))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 14, y: 5))
        bezierPath.addLine(to: CGPoint(x: 11, y: 5))
        bezierPath.addLine(to: CGPoint(x: 11, y: 4))
        bezierPath.addCurve(to: CGPoint(x: 9, y: 2), controlPoint1: CGPoint(x: 11, y: 2.89), controlPoint2: CGPoint(x: 10.11, y: 2))
        bezierPath.addLine(to: CGPoint(x: 2, y: 2))
        bezierPath.addCurve(to: CGPoint(x: 1, y: 1), controlPoint1: CGPoint(x: 2, y: 1.45), controlPoint2: CGPoint(x: 1.55, y: 1))
        bezierPath.addCurve(to: CGPoint(x: 0, y: 2), controlPoint1: CGPoint(x: 0.45, y: 1), controlPoint2: CGPoint(x: 0, y: 1.45))
        ...
        bezierPath.addLine(to: CGPoint(x: 4, y: 12))
        bezierPath.addLine(to: CGPoint(x: 4, y: 13))
        bezierPath.addCurve(to: CGPoint(x: 6, y: 15), controlPoint1: CGPoint(x: 4, y: 14.11), controlPoint2: CGPoint(x: 4.9, y: 15))
        bezierPath.addLine(to: CGPoint(x: 14, y: 15))
        bezierPath.addCurve(to: CGPoint(x: 16, y: 13), controlPoint1: CGPoint(x: 15.11, y: 15), controlPoint2: CGPoint(x: 16, y: 14.11))
        bezierPath.addLine(to: CGPoint(x: 16, y: 7))
        bezierPath.addCurve(to: CGPoint(x: 14, y: 5), controlPoint1: CGPoint(x: 16, y: 5.89), controlPoint2: CGPoint(x: 15.11, y: 5))
        bezierPath.addLine(to: CGPoint(x: 14, y: 5))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        fillColor35.setFill()
    ...
    @objc dynamic public class func drawChatDeleteIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 17, height: 17), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 4, y: 15))
        bezierPath.addLine(to: CGPoint(x: 12, y: 15))
        bezierPath.addLine(to: CGPoint(x: 12, y: 5))
        bezierPath.addLine(to: CGPoint(x: 4, y: 5))
        bezierPath.addLine(to: CGPoint(x: 4, y: 15))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 15, y: 5))
        bezierPath.addLine(to: CGPoint(x: 14, y: 5))
        bezierPath.addLine(to: CGPoint(x: 14, y: 15))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 17), controlPoint1: CGPoint(x: 14, y: 16.11), controlPoint2: CGPoint(x: 13.11, y: 17))
        bezierPath.addLine(to: CGPoint(x: 4, y: 17))
        bezierPath.addCurve(to: CGPoint(x: 2, y: 15), controlPoint1: CGPoint(x: 2.9, y: 17), controlPoint2: CGPoint(x: 2, y: 16.11))
        bezierPath.addLine(to: CGPoint(x: 2, y: 5))
        bezierPath.addLine(to: CGPoint(x: 1, y: 5))
        bezierPath.addLine(to: CGPoint(x: 1, y: 3))
        bezierPath.addLine(to: CGPoint(x: 2, y: 3))
        bezierPath.addLine(to: CGPoint(x: 5, y: 3))
        bezierPath.addLine(to: CGPoint(x: 5, y: 2))
        bezierPath.addCurve(to: CGPoint(x: 6, y: 1), controlPoint1: CGPoint(x: 5, y: 1.45), controlPoint2: CGPoint(x: 5.45, y: 1))
        bezierPath.addLine(to: CGPoint(x: 10, y: 1))
        bezierPath.addCurve(to: CGPoint(x: 11, y: 2), controlPoint1: CGPoint(x: 10.55, y: 1), controlPoint2: CGPoint(x: 11, y: 1.45))
        bezierPath.addLine(to: CGPoint(x: 11, y: 3))
        bezierPath.addLine(to: CGPoint(x: 14, y: 3))
        bezierPath.addLine(to: CGPoint(x: 15, y: 3))
        bezierPath.addLine(to: CGPoint(x: 15, y: 5))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 9, y: 13))
        bezierPath.addLine(to: CGPoint(x: 10, y: 13))
        bezierPath.addLine(to: CGPoint(x: 10, y: 7))
        bezierPath.addLine(to: CGPoint(x: 9, y: 7))
        bezierPath.addLine(to: CGPoint(x: 9, y: 13))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 6, y: 13))
    ...
    @objc dynamic public class func drawAlertIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 16, height: 16), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let fillColor105 = UIColor(red: 1.000, green: 0.380, blue: 0.396, alpha: 1.000)

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 0.01, y: 2.05))
        bezierPath.addCurve(to: CGPoint(x: 2, y: 0.05), controlPoint1: CGPoint(x: 0.01, y: 0.95), controlPoint2: CGPoint(x: 0.9, y: 0.05))
        bezierPath.addLine(to: CGPoint(x: 14.01, y: 0.05))
        bezierPath.addCurve(to: CGPoint(x: 16.01, y: 2.05), controlPoint1: CGPoint(x: 15.11, y: 0.05), controlPoint2: CGPoint(x: 16.01, y: 0.95))
        bezierPath.addLine(to: CGPoint(x: 16.01, y: 14.06))
        bezierPath.addLine(to: CGPoint(x: 16.01, y: 14.06))
        bezierPath.addCurve(to: CGPoint(x: 14.01, y: 16.05), controlPoint1: CGPoint(x: 16.01, y: 15.16), controlPoint2: CGPoint(x: 15.11, y: 16.05))
        bezierPath.addLine(to: CGPoint(x: 2, y: 16.05))
        bezierPath.addLine(to: CGPoint(x: 2, y: 16.05))
        bezierPath.addCurve(to: CGPoint(x: 0.01, y: 14.06), controlPoint1: CGPoint(x: 0.9, y: 16.05), controlPoint2: CGPoint(x: 0.01, y: 15.16))
        bezierPath.addLine(to: CGPoint(x: 0.01, y: 2.05))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 2.01, y: 2.05))
        bezierPath.addLine(to: CGPoint(x: 2.01, y: 14.05))
        bezierPath.addLine(to: CGPoint(x: 14.01, y: 14.05))
        bezierPath.addLine(to: CGPoint(x: 14.01, y: 2.05))
        bezierPath.addLine(to: CGPoint(x: 2.01, y: 2.05))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 7.01, y: 4.05))
        bezierPath.addLine(to: CGPoint(x: 9.01, y: 4.05))
        bezierPath.addLine(to: CGPoint(x: 9.01, y: 9.05))
        bezierPath.addLine(to: CGPoint(x: 7.01, y: 9.05))
        bezierPath.addLine(to: CGPoint(x: 7.01, y: 4.05))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 7.01, y: 10.05))
        bezierPath.addLine(to: CGPoint(x: 9.01, y: 10.05))
        bezierPath.addLine(to: CGPoint(x: 9.01, y: 12.05))
        bezierPath.addLine(to: CGPoint(x: 7.01, y: 12.05))
        bezierPath.addLine(to: CGPoint(x: 7.01, y: 10.05))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
    ...
    @objc dynamic public class func drawItemIndicatorLockedDark(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground, isLocked: true, isLimited: false, isDark: true)
        context.restoreGState()
    ...
    @objc dynamic public class func drawBuffIconDark(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 15), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let fillColor39 = UIColor(red: 0.741, green: 0.659, blue: 1.000, alpha: 1.000)
        let buffBackgroundColorDark = UIColor(red: 0.273, green: 0.156, blue: 0.488, alpha: 1.000)

        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: 15, height: 15), cornerRadius: 2)
        buffBackgroundColorDark.setFill()
        rectanglePath.fill()
    ...
    @objc dynamic public class func drawStats(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 30, height: 22), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 30, height: 22), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 30, y: resizedFrame.height / 22)
        ...
        let fillColor40 = UIColor(red: 0.647, green: 0.631, blue: 0.675, alpha: 1.000)
        let fillColor89 = UIColor(red: 0.890, green: 0.561, blue: 0.239, alpha: 1.000)
        let fillColor106 = UIColor(red: 0.847, green: 0.847, blue: 0.847, alpha: 1.000)
        let strokeColor21 = UIColor(red: 0.529, green: 0.506, blue: 0.565, alpha: 1.000)
        let fillColor107 = UIColor(red: 0.702, green: 0.384, blue: 0.075, alpha: 1.000)

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 11.25, y: 19))
        bezierPath.addLine(to: CGPoint(x: 10, y: 20.25))
        bezierPath.addLine(to: CGPoint(x: 6, y: 20.25))
        bezierPath.addLine(to: CGPoint(x: 4.75, y: 19))
        bezierPath.addLine(to: CGPoint(x: 4.75, y: 17.25))
        bezierPath.addLine(to: CGPoint(x: 3, y: 17.25))
        bezierPath.addLine(to: CGPoint(x: 1.75, y: 16))
        bezierPath.addLine(to: CGPoint(x: 1.75, y: 6))
        bezierPath.addLine(to: CGPoint(x: 3, y: 4.75))
        bezierPath.addLine(to: CGPoint(x: 4.75, y: 4.75))
        bezierPath.addLine(to: CGPoint(x: 4.75, y: 3))
        bezierPath.addLine(to: CGPoint(x: 6, y: 1.75))
        bezierPath.addLine(to: CGPoint(x: 10, y: 1.75))
        bezierPath.addLine(to: CGPoint(x: 11.25, y: 3))
        bezierPath.addLine(to: CGPoint(x: 11.25, y: 7.75))
        bezierPath.addLine(to: CGPoint(x: 18.75, y: 7.75))
        bezierPath.addLine(to: CGPoint(x: 18.75, y: 3))
        bezierPath.addLine(to: CGPoint(x: 20, y: 1.75))
        bezierPath.addLine(to: CGPoint(x: 24, y: 1.75))
        bezierPath.addLine(to: CGPoint(x: 25.25, y: 3))
        bezierPath.addLine(to: CGPoint(x: 25.25, y: 4.75))
        bezierPath.addLine(to: CGPoint(x: 27, y: 4.75))
        bezierPath.addLine(to: CGPoint(x: 28.25, y: 6))
        bezierPath.addLine(to: CGPoint(x: 28.25, y: 16))
        bezierPath.addLine(to: CGPoint(x: 27, y: 17.25))
        bezierPath.addLine(to: CGPoint(x: 25.25, y: 17.25))
        bezierPath.addLine(to: CGPoint(x: 25.25, y: 19))
        bezierPath.addLine(to: CGPoint(x: 24, y: 20.25))
        bezierPath.addLine(to: CGPoint(x: 20, y: 20.25))
        bezierPath.addLine(to: CGPoint(x: 18.75, y: 19))
        bezierPath.addLine(to: CGPoint(x: 18.75, y: 14.25))
        bezierPath.addLine(to: CGPoint(x: 11.25, y: 14.25))
        bezierPath.addLine(to: CGPoint(x: 11.25, y: 19))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        ...
        //// Clip Clip
        let clipPath = UIBezierPath()
        clipPath.move(to: CGPoint(x: -22, y: -22))
        clipPath.addLine(to: CGPoint(x: 52, y: -22))
        clipPath.addLine(to: CGPoint(x: 52, y: 44))
        clipPath.addLine(to: CGPoint(x: -22, y: 44))
        clipPath.addLine(to: CGPoint(x: -22, y: -22))
        clipPath.close()
        clipPath.move(to: CGPoint(x: 10, y: 19))
        clipPath.addLine(to: CGPoint(x: 6, y: 19))
        clipPath.addLine(to: CGPoint(x: 6, y: 16))
        clipPath.addLine(to: CGPoint(x: 3, y: 16))
        clipPath.addLine(to: CGPoint(x: 3, y: 6))
        clipPath.addLine(to: CGPoint(x: 6, y: 6))
        clipPath.addLine(to: CGPoint(x: 6, y: 3))
        clipPath.addLine(to: CGPoint(x: 10, y: 3))
        clipPath.addLine(to: CGPoint(x: 10, y: 9))
        clipPath.addLine(to: CGPoint(x: 20, y: 9))
        clipPath.addLine(to: CGPoint(x: 20, y: 3))
        clipPath.addLine(to: CGPoint(x: 24, y: 3))
        clipPath.addLine(to: CGPoint(x: 24, y: 6))
        clipPath.addLine(to: CGPoint(x: 27, y: 6))
        clipPath.addLine(to: CGPoint(x: 27, y: 16))
        clipPath.addLine(to: CGPoint(x: 24, y: 16))
        clipPath.addLine(to: CGPoint(x: 24, y: 19))
        clipPath.addLine(to: CGPoint(x: 20, y: 19))
        clipPath.addLine(to: CGPoint(x: 20, y: 13))
        clipPath.addLine(to: CGPoint(x: 10, y: 13))
        clipPath.addLine(to: CGPoint(x: 10, y: 19))
        clipPath.close()
        clipPath.usesEvenOddFillRule = true
        clipPath.addClip()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 10, y: 19))
        bezier2Path.addLine(to: CGPoint(x: 6, y: 19))
        bezier2Path.addLine(to: CGPoint(x: 6, y: 16))
        bezier2Path.addLine(to: CGPoint(x: 3, y: 16))
        bezier2Path.addLine(to: CGPoint(x: 3, y: 6))
        bezier2Path.addLine(to: CGPoint(x: 6, y: 6))
        bezier2Path.addLine(to: CGPoint(x: 6, y: 3))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 3))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 9))
        bezier2Path.addLine(to: CGPoint(x: 20, y: 9))
        bezier2Path.addLine(to: CGPoint(x: 20, y: 3))
        bezier2Path.addLine(to: CGPoint(x: 24, y: 3))
        bezier2Path.addLine(to: CGPoint(x: 24, y: 6))
        bezier2Path.addLine(to: CGPoint(x: 27, y: 6))
        bezier2Path.addLine(to: CGPoint(x: 27, y: 16))
        bezier2Path.addLine(to: CGPoint(x: 24, y: 16))
        bezier2Path.addLine(to: CGPoint(x: 24, y: 19))
        bezier2Path.addLine(to: CGPoint(x: 20, y: 19))
        bezier2Path.addLine(to: CGPoint(x: 20, y: 13))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 13))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 19))
        bezier2Path.close()
        strokeColor21.setStroke()
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(rect: CGRect(x: 3, y: 6, width: 3, height: 10))
        fillColor40.setFill()
        rectanglePath.fill()


        //// Rectangle 2 Drawing
        let rectangle2Path = UIBezierPath(rect: CGRect(x: 24, y: 6, width: 3, height: 10))
        fillColor40.setFill()
        rectangle2Path.fill()


        //// Rectangle 3 Drawing
        let rectangle3Path = UIBezierPath(rect: CGRect(x: 10, y: 9, width: 10, height: 4))
        fillColor107.setFill()
        rectangle3Path.fill()


        //// Rectangle 4 Drawing
        let rectangle4Path = UIBezierPath(rect: CGRect(x: 12, y: 9, width: 2, height: 4))
        fillColor89.setFill()
        rectangle4Path.fill()


        //// Rectangle 5 Drawing
        let rectangle5Path = UIBezierPath(rect: CGRect(x: 16, y: 9, width: 2, height: 4))
        fillColor89.setFill()
        rectangle5Path.fill()


        //// Rectangle 6 Drawing
        let rectangle6Path = UIBezierPath(rect: CGRect(x: 6, y: 3, width: 4, height: 16))
        fillColor35.setFill()
        rectangle6Path.fill()


        //// Rectangle 7 Drawing
        let rectangle7Path = UIBezierPath(rect: CGRect(x: 20, y: 3, width: 4, height: 16))
        fillColor35.setFill()
        rectangle7Path.fill()


        //// Rectangle 8 Drawing
        let rectangle8Path = UIBezierPath(rect: CGRect(x: 6, y: 3, width: 4, height: 8))
        fillColor25.setFill()
        rectangle8Path.fill()


        //// Rectangle 9 Drawing
        let rectangle9Path = UIBezierPath(rect: CGRect(x: 3, y: 6, width: 3, height: 5))
        fillColor35.setFill()
        rectangle9Path.fill()


        //// Rectangle 10 Drawing
        let rectangle10Path = UIBezierPath(rect: CGRect(x: 24, y: 6, width: 3, height: 5))
        fillColor35.setFill()
        rectangle10Path.fill()


        //// Rectangle 11 Drawing
        let rectangle11Path = UIBezierPath(rect: CGRect(x: 20, y: 3, width: 4, height: 8))
        fillColor25.setFill()
        rectangle11Path.fill()
    ...
    @objc dynamic public class func drawDashBorder(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 113, height: 116), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 113, height: 116), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 113, y: resizedFrame.height / 116)


        //// Color Declarations
        let strokeColor22 = UIColor(red: 0.380, green: 0.200, blue: 0.706, alpha: 1.000)
        let strokeColor23 = UIColor(red: 0.835, green: 0.784, blue: 1.000, alpha: 1.000)

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 18, y: 2))
        bezierPath.addLine(to: CGPoint(x: 2, y: 2))
        bezierPath.addLine(to: CGPoint(x: 2, y: 18))
        strokeColor22.setStroke()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 18, y: 114))
        bezier2Path.addLine(to: CGPoint(x: 2, y: 114))
        bezier2Path.addLine(to: CGPoint(x: 2, y: 98))
        strokeColor22.setStroke()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 95, y: 2))
        bezier3Path.addLine(to: CGPoint(x: 111, y: 2))
        bezier3Path.addLine(to: CGPoint(x: 111, y: 18))
        strokeColor22.setStroke()
        ...
        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: 95, y: 114))
        bezier4Path.addLine(to: CGPoint(x: 111, y: 114))
        bezier4Path.addLine(to: CGPoint(x: 111, y: 98))
        strokeColor22.setStroke()
        ...
        //// Bezier 5 Drawing
        let bezier5Path = UIBezierPath()
        bezier5Path.move(to: CGPoint(x: 2, y: 22))
        bezier5Path.addLine(to: CGPoint(x: 2, y: 94))
        strokeColor23.setStroke()
        ...
        //// Bezier 6 Drawing
        let bezier6Path = UIBezierPath()
        bezier6Path.move(to: CGPoint(x: 111, y: 22))
        bezier6Path.addLine(to: CGPoint(x: 111, y: 94))
        strokeColor23.setStroke()
        ...
        //// Bezier 7 Drawing
        let bezier7Path = UIBezierPath()
        bezier7Path.move(to: CGPoint(x: 22, y: 114))
        bezier7Path.addLine(to: CGPoint(x: 94, y: 114))
        strokeColor23.setStroke()
        ...
        //// Bezier 8 Drawing
        let bezier8Path = UIBezierPath()
        bezier8Path.move(to: CGPoint(x: 22, y: 2))
        bezier8Path.addLine(to: CGPoint(x: 94, y: 2))
        strokeColor23.setStroke()
    ...
    @objc dynamic public class func drawTaskFilterIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 30, height: 28), resizing: ResizingBehavior = .aspectFit, filter_active: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 30, height: 28), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 30, y: resizedFrame.height / 28)


        //// Color Declarations
        let strokeColor18 = UIColor(red: 0.306, green: 0.290, blue: 0.341, alpha: 1.000)
        let fillColor108 = UIColor(red: 0.306, green: 0.290, blue: 0.341, alpha: 1.000)

        //// Group
        //// Group 2
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 4.5, y: 7.5))
        bezierPath.addLine(to: CGPoint(x: 24.5, y: 7.5))
        strokeColor18.setStroke()
        bezierPath.lineWidth = 2
        bezierPath.lineCapStyle = .round
        bezierPath.stroke()
        ...
        bezier2Path.addLine(to: CGPoint(x: 21.5, y: 14.5))
        strokeColor18.setStroke()
        bezier2Path.lineWidth = 2
        bezier2Path.lineCapStyle = .round
        bezier2Path.stroke()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 10.5, y: 21.5))
        bezier3Path.addLine(to: CGPoint(x: 18.5, y: 21.5))
        strokeColor18.setStroke()
        bezier3Path.lineWidth = 2
        bezier3Path.lineCapStyle = .round
        bezier3Path.stroke()
        ...
        if (filter_active) {
            //// Oval Drawing
            let ovalPath = UIBezierPath(ovalIn: CGRect(x: 19.5, y: 1, width: 10, height: 10))
    ...
    @objc dynamic public class func drawFallGemPromoBG(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 132, height: 35), resizing: ResizingBehavior = .aspectFit, redGemColor: UIColor = UIColor(red: 1.000, green: 0.380, blue: 0.396, alpha: 1.000), greenGemColor: UIColor = UIColor(red: 0.141, green: 0.800, blue: 0.561, alpha: 1.000), blueGemColor: UIColor = UIColor(red: 0.275, green: 0.655, blue: 0.851, alpha: 1.000), purpleGemColor: UIColor = UIColor(red: 0.573, green: 0.361, blue: 0.953, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 132, height: 35), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 132, y: resizedFrame.height / 35)


        //// Color Declarations
        let strokeColor26 = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        ...
        //// Clip Clip 2
        let clip2Path = UIBezierPath()
        clip2Path.move(to: CGPoint(x: 110.54, y: 4.1))
        clip2Path.addLine(to: CGPoint(x: 110.05, y: 8.37))
        clip2Path.addLine(to: CGPoint(x: 115.26, y: 13.06))
        clip2Path.addLine(to: CGPoint(x: 119.46, y: 12.13))
        clip2Path.addLine(to: CGPoint(x: 119.35, y: 3.28))
        clip2Path.addLine(to: CGPoint(x: 110.54, y: 4.1))
        clip2Path.close()
        clip2Path.usesEvenOddFillRule = true
        clip2Path.addClip()
        ...
        //// Clip Clip
        let clipPath = UIBezierPath(rect: CGRect(x: 110, y: 3, width: 10, height: 11))
        clipPath.addClip()


        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 110.54, y: 4.1))
        bezierPath.addLine(to: CGPoint(x: 110.05, y: 8.37))
        bezierPath.addLine(to: CGPoint(x: 115.26, y: 13.06))
        bezierPath.addLine(to: CGPoint(x: 119.46, y: 12.13))
        bezierPath.addLine(to: CGPoint(x: 119.35, y: 3.28))
        bezierPath.addLine(to: CGPoint(x: 110.54, y: 4.1))
        bezierPath.close()
        blueGemColor.setStroke()
        bezierPath.lineWidth = 2
        ...
        clip4Path.move(to: CGPoint(x: 126.18, y: 29))
        clip4Path.addLine(to: CGPoint(x: 124.61, y: 25))
        clip4Path.addLine(to: CGPoint(x: 117.81, y: 23.3))
        clip4Path.addLine(to: CGPoint(x: 114.54, y: 26.09))
        clip4Path.addLine(to: CGPoint(x: 118.79, y: 33.85))
        clip4Path.addLine(to: CGPoint(x: 126.18, y: 29))
        clip4Path.close()
        ...
        //// Clip Clip 3
        let clip3Path = UIBezierPath(rect: CGRect(x: 114, y: 23, width: 13, height: 11))
        clip3Path.addClip()


        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 126.18, y: 29))
        bezier3Path.addLine(to: CGPoint(x: 124.61, y: 25))
        bezier3Path.addLine(to: CGPoint(x: 117.81, y: 23.3))
        bezier3Path.addLine(to: CGPoint(x: 114.54, y: 26.09))
        bezier3Path.addLine(to: CGPoint(x: 118.79, y: 33.85))
        bezier3Path.addLine(to: CGPoint(x: 126.18, y: 29))
        bezier3Path.close()
        purpleGemColor.setStroke()
        bezier3Path.lineWidth = 2
        ...
        //// Bezier 5 Drawing
        let bezier5Path = UIBezierPath()
        bezier5Path.move(to: CGPoint(x: 109.08, y: 21.16))
        bezier5Path.addCurve(to: CGPoint(x: 107, y: 19), controlPoint1: CGPoint(x: 109.35, y: 19.51), controlPoint2: CGPoint(x: 108.65, y: 18.79))
        bezier5Path.addCurve(to: CGPoint(x: 104.92, y: 16.84), controlPoint1: CGPoint(x: 105.35, y: 19.21), controlPoint2: CGPoint(x: 104.65, y: 18.49))
        strokeColor26.setStroke()
        ...
        //// Bezier 6 Drawing
        let bezier6Path = UIBezierPath()
        bezier6Path.move(to: CGPoint(x: 129.02, y: 12.84))
        bezier6Path.addCurve(to: CGPoint(x: 130, y: 10), controlPoint1: CGPoint(x: 130.61, y: 12.33), controlPoint2: CGPoint(x: 130.94, y: 11.38))
        bezier6Path.addCurve(to: CGPoint(x: 130.98, y: 7.16), controlPoint1: CGPoint(x: 129.06, y: 8.62), controlPoint2: CGPoint(x: 129.39, y: 7.67))
        strokeColor26.setStroke()
        ...
        //// Clip Clip 6
        let clip6Path = UIBezierPath()
        clip6Path.move(to: CGPoint(x: 12.78, y: 1.47))
        clip6Path.addLine(to: CGPoint(x: 16.79, y: -0.1))
        clip6Path.addLine(to: CGPoint(x: 22.66, y: 3.71))
        clip6Path.addLine(to: CGPoint(x: 22.85, y: 8.01))
        clip6Path.addLine(to: CGPoint(x: 14.28, y: 10.19))
        clip6Path.addLine(to: CGPoint(x: 12.78, y: 1.47))
        clip6Path.close()
        clip6Path.usesEvenOddFillRule = true
        clip6Path.addClip()
        ...
        //// Clip Clip 5
        let clip5Path = UIBezierPath(rect: CGRect(x: 12, y: -1, width: 11, height: 12))
        clip5Path.addClip()


        //// Bezier 7 Drawing
        let bezier7Path = UIBezierPath()
        bezier7Path.move(to: CGPoint(x: 12.78, y: 1.47))
        bezier7Path.addLine(to: CGPoint(x: 16.79, y: -0.1))
        bezier7Path.addLine(to: CGPoint(x: 22.66, y: 3.71))
        bezier7Path.addLine(to: CGPoint(x: 22.85, y: 8.01))
        bezier7Path.addLine(to: CGPoint(x: 14.28, y: 10.19))
        bezier7Path.addLine(to: CGPoint(x: 12.78, y: 1.47))
        bezier7Path.close()
        redGemColor.setStroke()
        ...
        clip8Path.move(to: CGPoint(x: 6.82, y: 28.21))
        clip8Path.addLine(to: CGPoint(x: 8.26, y: 24.16))
        clip8Path.addLine(to: CGPoint(x: 14.99, y: 22.23))
        clip8Path.addLine(to: CGPoint(x: 18.35, y: 24.9))
        clip8Path.addLine(to: CGPoint(x: 14.38, y: 32.81))
        clip8Path.addLine(to: CGPoint(x: 6.82, y: 28.21))
        clip8Path.close()
        ...
        //// Clip Clip 7
        let clip7Path = UIBezierPath(rect: CGRect(x: 6, y: 22, width: 13, height: 11))
        clip7Path.addClip()


        //// Bezier 9 Drawing
        let bezier9Path = UIBezierPath()
        bezier9Path.move(to: CGPoint(x: 6.82, y: 28.21))
        bezier9Path.addLine(to: CGPoint(x: 8.26, y: 24.16))
        bezier9Path.addLine(to: CGPoint(x: 14.99, y: 22.23))
        bezier9Path.addLine(to: CGPoint(x: 18.35, y: 24.9))
        bezier9Path.addLine(to: CGPoint(x: 14.38, y: 32.81))
        bezier9Path.addLine(to: CGPoint(x: 6.82, y: 28.21))
        bezier9Path.close()
        greenGemColor.setStroke()
        ...
        //// Bezier 11 Drawing
        let bezier11Path = UIBezierPath()
        bezier11Path.move(to: CGPoint(x: 29.3, y: 20.93))
        bezier11Path.addCurve(to: CGPoint(x: 27, y: 19), controlPoint1: CGPoint(x: 27.68, y: 21.31), controlPoint2: CGPoint(x: 26.91, y: 20.66))
        bezier11Path.addCurve(to: CGPoint(x: 24.7, y: 17.07), controlPoint1: CGPoint(x: 27.09, y: 17.34), controlPoint2: CGPoint(x: 26.32, y: 16.69))
        strokeColor26.setStroke()
        ...
        //// Bezier 12 Drawing
        let bezier12Path = UIBezierPath()
        bezier12Path.move(to: CGPoint(x: 1.69, y: 16.98))
        bezier12Path.addCurve(to: CGPoint(x: 2, y: 14), controlPoint1: CGPoint(x: 0.46, y: 15.85), controlPoint2: CGPoint(x: 0.57, y: 14.86))
        bezier12Path.addCurve(to: CGPoint(x: 2.31, y: 11.02), controlPoint1: CGPoint(x: 3.43, y: 13.14), controlPoint2: CGPoint(x: 3.54, y: 12.15))
        strokeColor26.setStroke()
    ...
    @objc dynamic public class func drawSpookyGemPromoBG(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 132, height: 35), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let fillColor73 = UIColor(red: 1.000, green: 0.706, blue: 0.271, alpha: 1.000)
        let strokeColor24 = UIColor(red: 0.573, green: 0.361, blue: 0.953, alpha: 1.000)
        let fillColor109 = UIColor(red: 0.980, green: 0.522, blue: 0.216, alpha: 1.000)

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 27.3, y: 22.93))
        bezierPath.addCurve(to: CGPoint(x: 25, y: 21), controlPoint1: CGPoint(x: 25.68, y: 23.31), controlPoint2: CGPoint(x: 24.91, y: 22.66))
        bezierPath.addCurve(to: CGPoint(x: 22.7, y: 19.07), controlPoint1: CGPoint(x: 25.09, y: 19.34), controlPoint2: CGPoint(x: 24.32, y: 18.69))
        strokeColor24.setStroke()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 2.69, y: 13.98))
        bezier2Path.addCurve(to: CGPoint(x: 3, y: 11), controlPoint1: CGPoint(x: 1.46, y: 12.85), controlPoint2: CGPoint(x: 1.57, y: 11.86))
        bezier2Path.addCurve(to: CGPoint(x: 3.31, y: 8.02), controlPoint1: CGPoint(x: 4.43, y: 10.14), controlPoint2: CGPoint(x: 4.54, y: 9.15))
        strokeColor24.setStroke()
        ...
        //// Clip Clip
        let clipPath = UIBezierPath()
        clipPath.move(to: CGPoint(x: 9.58, y: 25.14))
        clipPath.addCurve(to: CGPoint(x: 8.95, y: 28.1), controlPoint1: CGPoint(x: 9.58, y: 25.14), controlPoint2: CGPoint(x: 10.18, y: 27.22))
        clipPath.addLine(to: CGPoint(x: 8.57, y: 27.2))
        clipPath.addCurve(to: CGPoint(x: 7.98, y: 27.94), controlPoint1: CGPoint(x: 8.57, y: 27.2), controlPoint2: CGPoint(x: 8.51, y: 27.72))
        clipPath.addCurve(to: CGPoint(x: 7.03, y: 27.85), controlPoint1: CGPoint(x: 7.44, y: 28.17), controlPoint2: CGPoint(x: 7.03, y: 27.85))
        clipPath.addLine(to: CGPoint(x: 7.41, y: 28.75))
        clipPath.addCurve(to: CGPoint(x: 4.85, y: 27.15), controlPoint1: CGPoint(x: 5.92, y: 29.03), controlPoint2: CGPoint(x: 4.85, y: 27.15))
        clipPath.addCurve(to: CGPoint(x: 0.44, y: 28.1), controlPoint1: CGPoint(x: 2.67, y: 26.45), controlPoint2: CGPoint(x: 0.44, y: 28.1))
        clipPath.addCurve(to: CGPoint(x: 2.8, y: 30.21), controlPoint1: CGPoint(x: 2.46, y: 28.59), controlPoint2: CGPoint(x: 2.8, y: 30.21))
        clipPath.addCurve(to: CGPoint(x: 5.83, y: 31.12), controlPoint1: CGPoint(x: 4.9, y: 29.25), controlPoint2: CGPoint(x: 5.83, y: 31.12))
        clipPath.addCurve(to: CGPoint(x: 9.17, y: 30.76), controlPoint1: CGPoint(x: 7.34, y: 28.92), controlPoint2: CGPoint(x: 9.17, y: 30.76))
        clipPath.addCurve(to: CGPoint(x: 11.75, y: 28.61), controlPoint1: CGPoint(x: 9.17, y: 30.76), controlPoint2: CGPoint(x: 9.12, y: 28.17))
        clipPath.addCurve(to: CGPoint(x: 13.2, y: 25.8), controlPoint1: CGPoint(x: 11.75, y: 28.61), controlPoint2: CGPoint(x: 11.05, y: 26.64))
        clipPath.addCurve(to: CGPoint(x: 13.33, y: 22.63), controlPoint1: CGPoint(x: 13.2, y: 25.8), controlPoint2: CGPoint(x: 12.27, y: 24.42))
        clipPath.addCurve(to: CGPoint(x: 9.58, y: 25.14), controlPoint1: CGPoint(x: 13.33, y: 22.63), controlPoint2: CGPoint(x: 10.59, y: 23.09))
        clipPath.close()
        clipPath.usesEvenOddFillRule = true
        clipPath.addClip()
        ...
        //// Rectangle 2 Drawing
        context.saveGState()
        context.translateBy(x: 8, y: 28)
        context.rotate(by: -23 * CGFloat.pi/180)

        let rectangle2Path = UIBezierPath(rect: CGRect(x: -12, y: -8, width: 24, height: 16))
        ...
        //// Clip Clip 2
        let clip2Path = UIBezierPath()
        clip2Path.move(to: CGPoint(x: 27.55, y: 5.58))
        clip2Path.addCurve(to: CGPoint(x: 23.08, y: 4.93), controlPoint1: CGPoint(x: 27.55, y: 5.58), controlPoint2: CGPoint(x: 25.21, y: 4.08))
        clip2Path.addCurve(to: CGPoint(x: 20.64, y: 6.71), controlPoint1: CGPoint(x: 23.08, y: 4.93), controlPoint2: CGPoint(x: 22.14, y: 6.88))
        clip2Path.addLine(to: CGPoint(x: 20.96, y: 5.78))
        clip2Path.addCurve(to: CGPoint(x: 20.02, y: 5.94), controlPoint1: CGPoint(x: 20.96, y: 5.78), controlPoint2: CGPoint(x: 20.57, y: 6.13))
        clip2Path.addCurve(to: CGPoint(x: 19.38, y: 5.24), controlPoint1: CGPoint(x: 19.47, y: 5.76), controlPoint2: CGPoint(x: 19.38, y: 5.24))
        clip2Path.addLine(to: CGPoint(x: 19.06, y: 6.16))
        clip2Path.addCurve(to: CGPoint(x: 18.23, y: 3.26), controlPoint1: CGPoint(x: 17.77, y: 5.38), controlPoint2: CGPoint(x: 18.23, y: 3.26))
        clip2Path.addCurve(to: CGPoint(x: 14.31, y: 1.02), controlPoint1: CGPoint(x: 17.07, y: 1.28), controlPoint2: CGPoint(x: 14.31, y: 1.02))
        clip2Path.addCurve(to: CGPoint(x: 14.65, y: 4.17), controlPoint1: CGPoint(x: 15.49, y: 2.73), controlPoint2: CGPoint(x: 14.65, y: 4.17))
        clip2Path.addCurve(to: CGPoint(x: 16.31, y: 6.87), controlPoint1: CGPoint(x: 16.86, y: 4.86), controlPoint2: CGPoint(x: 16.31, y: 6.87))
        clip2Path.addCurve(to: CGPoint(x: 19.02, y: 8.84), controlPoint1: CGPoint(x: 18.9, y: 6.25), controlPoint2: CGPoint(x: 19.02, y: 8.84))
        clip2Path.addCurve(to: CGPoint(x: 22.38, y: 8.96), controlPoint1: CGPoint(x: 19.02, y: 8.84), controlPoint2: CGPoint(x: 20.72, y: 6.87))
        clip2Path.addCurve(to: CGPoint(x: 25.34, y: 7.84), controlPoint1: CGPoint(x: 22.38, y: 8.96), controlPoint2: CGPoint(x: 23.18, y: 7.03))
        clip2Path.addCurve(to: CGPoint(x: 27.55, y: 5.58), controlPoint1: CGPoint(x: 25.34, y: 7.84), controlPoint2: CGPoint(x: 25.57, y: 6.2))
        clip2Path.close()
        clip2Path.usesEvenOddFillRule = true
        clip2Path.addClip()
        ...
        let rectangle3Path = UIBezierPath(rect: CGRect(x: -12, y: -8, width: 24, height: 16))
        fillColor73.setFill()
        rectangle3Path.fill()
        ...
        //// Bezier 5 Drawing
        let bezier5Path = UIBezierPath()
        bezier5Path.move(to: CGPoint(x: 108.08, y: 19.16))
        bezier5Path.addCurve(to: CGPoint(x: 106, y: 17), controlPoint1: CGPoint(x: 108.35, y: 17.51), controlPoint2: CGPoint(x: 107.65, y: 16.79))
        bezier5Path.addCurve(to: CGPoint(x: 103.92, y: 14.84), controlPoint1: CGPoint(x: 104.35, y: 17.21), controlPoint2: CGPoint(x: 103.65, y: 16.49))
        strokeColor24.setStroke()
        bezier5Path.lineWidth = 1
        bezier5Path.miterLimit = 10
        bezier5Path.lineCapStyle = .round
        ...
        //// Bezier 6 Drawing
        let bezier6Path = UIBezierPath()
        bezier6Path.move(to: CGPoint(x: 128.02, y: 13.84))
        bezier6Path.addCurve(to: CGPoint(x: 129, y: 11), controlPoint1: CGPoint(x: 129.61, y: 13.33), controlPoint2: CGPoint(x: 129.94, y: 12.38))
        bezier6Path.addCurve(to: CGPoint(x: 129.98, y: 8.16), controlPoint1: CGPoint(x: 128.06, y: 9.62), controlPoint2: CGPoint(x: 128.39, y: 8.67))
        strokeColor24.setStroke()
        bezier6Path.lineWidth = 1
        bezier6Path.miterLimit = 10
        bezier6Path.lineCapStyle = .round
        ...
        clip3Path.move(to: CGPoint(x: 117, y: 4.72))
        clip3Path.addCurve(to: CGPoint(x: 114.69, y: 6.66), controlPoint1: CGPoint(x: 117, y: 4.72), controlPoint2: CGPoint(x: 116.2, y: 6.73))
        clip3Path.addLine(to: CGPoint(x: 114.94, y: 5.72))
        clip3Path.addCurve(to: CGPoint(x: 114.02, y: 5.94), controlPoint1: CGPoint(x: 114.94, y: 5.72), controlPoint2: CGPoint(x: 114.57, y: 6.09))
        clip3Path.addCurve(to: CGPoint(x: 113.33, y: 5.29), controlPoint1: CGPoint(x: 113.46, y: 5.79), controlPoint2: CGPoint(x: 113.33, y: 5.29))
        clip3Path.addLine(to: CGPoint(x: 113.07, y: 6.23))
        clip3Path.addCurve(to: CGPoint(x: 112.04, y: 3.39), controlPoint1: CGPoint(x: 111.73, y: 5.53), controlPoint2: CGPoint(x: 112.04, y: 3.39))
        clip3Path.addCurve(to: CGPoint(x: 107.98, y: 1.43), controlPoint1: CGPoint(x: 110.75, y: 1.5), controlPoint2: CGPoint(x: 107.98, y: 1.43))
        clip3Path.addCurve(to: CGPoint(x: 108.54, y: 4.54), controlPoint1: CGPoint(x: 109.27, y: 3.05), controlPoint2: CGPoint(x: 108.54, y: 4.54))
        clip3Path.addCurve(to: CGPoint(x: 110.37, y: 7.12), controlPoint1: CGPoint(x: 110.79, y: 5.08), controlPoint2: CGPoint(x: 110.37, y: 7.12))
        clip3Path.addCurve(to: CGPoint(x: 113.22, y: 8.9), controlPoint1: CGPoint(x: 112.92, y: 6.32), controlPoint2: CGPoint(x: 113.22, y: 8.9))
        clip3Path.addCurve(to: CGPoint(x: 116.58, y: 8.79), controlPoint1: CGPoint(x: 113.22, y: 8.9), controlPoint2: CGPoint(x: 114.78, y: 6.82))
        clip3Path.addCurve(to: CGPoint(x: 119.46, y: 7.47), controlPoint1: CGPoint(x: 116.58, y: 8.79), controlPoint2: CGPoint(x: 117.24, y: 6.81))
        clip3Path.addCurve(to: CGPoint(x: 121.5, y: 5.05), controlPoint1: CGPoint(x: 119.46, y: 7.47), controlPoint2: CGPoint(x: 119.57, y: 5.81))
        clip3Path.addCurve(to: CGPoint(x: 117, y: 4.72), controlPoint1: CGPoint(x: 121.5, y: 5.05), controlPoint2: CGPoint(x: 119.06, y: 3.72))
        clip3Path.close()
        ...
        //// Rectangle 4 Drawing
        context.saveGState()
        context.translateBy(x: 114, y: 6)
        context.rotate(by: 15 * CGFloat.pi/180)

        let rectangle4Path = UIBezierPath(rect: CGRect(x: -12, y: -8, width: 24, height: 16))
        fillColor109.setFill()
        rectangle4Path.fill()
        ...
        //// Clip Clip 4
        let clip4Path = UIBezierPath()
        clip4Path.move(to: CGPoint(x: 122.63, y: 22.02))
        clip4Path.addCurve(to: CGPoint(x: 119.22, y: 24.97), controlPoint1: CGPoint(x: 122.63, y: 22.02), controlPoint2: CGPoint(x: 119.97, y: 22.81))
        clip4Path.addCurve(to: CGPoint(x: 118.95, y: 27.98), controlPoint1: CGPoint(x: 119.22, y: 24.97), controlPoint2: CGPoint(x: 120.07, y: 26.96))
        clip4Path.addLine(to: CGPoint(x: 118.47, y: 27.14))
        clip4Path.addCurve(to: CGPoint(x: 117.97, y: 27.95), controlPoint1: CGPoint(x: 118.47, y: 27.14), controlPoint2: CGPoint(x: 118.47, y: 27.66))
        clip4Path.addCurve(to: CGPoint(x: 117.02, y: 27.97), controlPoint1: CGPoint(x: 117.47, y: 28.24), controlPoint2: CGPoint(x: 117.02, y: 27.97))
        clip4Path.addLine(to: CGPoint(x: 117.51, y: 28.82))
        clip4Path.addCurve(to: CGPoint(x: 114.77, y: 27.54), controlPoint1: CGPoint(x: 116.07, y: 29.27), controlPoint2: CGPoint(x: 114.77, y: 27.54))
        clip4Path.addCurve(to: CGPoint(x: 110.51, y: 29.02), controlPoint1: CGPoint(x: 112.52, y: 27.11), controlPoint2: CGPoint(x: 110.51, y: 29.02))
        clip4Path.addCurve(to: CGPoint(x: 113.11, y: 30.83), controlPoint1: CGPoint(x: 112.57, y: 29.26), controlPoint2: CGPoint(x: 113.11, y: 30.83))
        clip4Path.addCurve(to: CGPoint(x: 116.23, y: 31.36), controlPoint1: CGPoint(x: 115.08, y: 29.62), controlPoint2: CGPoint(x: 116.23, y: 31.36))
        clip4Path.addCurve(to: CGPoint(x: 119.5, y: 30.6), controlPoint1: CGPoint(x: 117.46, y: 28.99), controlPoint2: CGPoint(x: 119.5, y: 30.6))
        clip4Path.addCurve(to: CGPoint(x: 121.79, y: 28.15), controlPoint1: CGPoint(x: 119.5, y: 30.6), controlPoint2: CGPoint(x: 119.13, y: 28.03))
        clip4Path.addCurve(to: CGPoint(x: 122.9, y: 25.18), controlPoint1: CGPoint(x: 121.79, y: 28.15), controlPoint2: CGPoint(x: 120.86, y: 26.28))
        clip4Path.addCurve(to: CGPoint(x: 122.63, y: 22.02), controlPoint1: CGPoint(x: 122.9, y: 25.18), controlPoint2: CGPoint(x: 121.81, y: 23.93))
        clip4Path.close()
        clip4Path.usesEvenOddFillRule = true
        clip4Path.addClip()
        ...
        //// Rectangle 5 Drawing
        context.saveGState()
        context.translateBy(x: 118, y: 28)
        context.rotate(by: -30 * CGFloat.pi/180)

        let rectangle5Path = UIBezierPath(rect: CGRect(x: -12, y: -8, width: 24, height: 16))
        fillColor73.setFill()
        rectangle5Path.fill()
    ...
    @objc dynamic public class func drawItemIndicatorNumberDark(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground, isLocked: false, isLimited: false, isDark: true)
        context.restoreGState()
    ...
    @objc dynamic public class func imageOfItemIndicatorNumber(indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 28, height: 28), false, 0)
            HabiticaIcons.drawItemIndicatorNumber(indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground)

        let imageOfItemIndicatorNumber = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfItemIndicatorNumber
    }

    @objc dynamic public class func imageOfItemIndicatorLocked(indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 28, height: 28), false, 0)
            HabiticaIcons.drawItemIndicatorLocked(indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground)

        let imageOfItemIndicatorLocked = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfItemIndicatorLocked
    }

    @objc dynamic public class func imageOfItemIndicatorLimited(indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 28, height: 28), false, 0)
            HabiticaIcons.drawItemIndicatorLimited(indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground)

        let imageOfItemIndicatorLimited = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @objc dynamic public class func imageOfLocked(lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 15, height: 17), false, 0)
            HabiticaIcons.drawLocked(lockColor: lockColor)

        let imageOfLocked = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @objc dynamic public class var imageOfAlertIcon: UIImage {
        if Cache.imageOfAlertIcon != nil {
            return Cache.imageOfAlertIcon!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 16, height: 16), false, 0)
            HabiticaIcons.drawAlertIcon()
    ...
    @objc dynamic public class func imageOfItemIndicatorLockedDark(indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 28, height: 28), false, 0)
            HabiticaIcons.drawItemIndicatorLockedDark(indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground)

        let imageOfItemIndicatorLockedDark = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfItemIndicatorLockedDark
    }

    @objc dynamic public class var imageOfBuffIconDark: UIImage {
        if Cache.imageOfBuffIconDark != nil {
            return Cache.imageOfBuffIconDark!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 15, height: 15), false, 0)
            HabiticaIcons.drawBuffIconDark()

        Cache.imageOfBuffIconDark = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfBuffIconDark!
    }

    @objc dynamic public class var imageOfStats: UIImage {
        if Cache.imageOfStats != nil {
            return Cache.imageOfStats!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 30, height: 22), false, 0)
            HabiticaIcons.drawStats()

        Cache.imageOfStats = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfStats!
    }

    @objc dynamic public class var imageOfDashBorder: UIImage {
        if Cache.imageOfDashBorder != nil {
            return Cache.imageOfDashBorder!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 113, height: 116), false, 0)
            HabiticaIcons.drawDashBorder()

        Cache.imageOfDashBorder = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfDashBorder!
    }

    @objc dynamic public class func imageOfTaskFilterIcon(filter_active: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 30, height: 28), false, 0)
            HabiticaIcons.drawTaskFilterIcon(filter_active: filter_active)

        let imageOfTaskFilterIcon = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfTaskFilterIcon
    }

    @objc dynamic public class func imageOfFallGemPromoBG(redGemColor: UIColor = UIColor(red: 1.000, green: 0.380, blue: 0.396, alpha: 1.000), greenGemColor: UIColor = UIColor(red: 0.141, green: 0.800, blue: 0.561, alpha: 1.000), blueGemColor: UIColor = UIColor(red: 0.275, green: 0.655, blue: 0.851, alpha: 1.000), purpleGemColor: UIColor = UIColor(red: 0.573, green: 0.361, blue: 0.953, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 132, height: 35), false, 0)
            HabiticaIcons.drawFallGemPromoBG(redGemColor: redGemColor, greenGemColor: greenGemColor, blueGemColor: blueGemColor, purpleGemColor: purpleGemColor)

        let imageOfFallGemPromoBG = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfFallGemPromoBG
    }

    @objc dynamic public class var imageOfSpookyGemPromoBG: UIImage {
        if Cache.imageOfSpookyGemPromoBG != nil {
            return Cache.imageOfSpookyGemPromoBG!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 132, height: 35), false, 0)
            HabiticaIcons.drawSpookyGemPromoBG()

        Cache.imageOfSpookyGemPromoBG = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfSpookyGemPromoBG!
    }

    @objc dynamic public class func imageOfItemIndicatorNumberDark(indicatorLocked: UIColor = UIColor(red: 0.929, green: 0.925, blue: 0.933, alpha: 1.000), lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), indicatorLockedDark: UIColor = UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1.000), itemIndicatorColorBackground: UIColor = UIColor(red: 0.647, green: 0.631, blue: 0.678, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 28, height: 28), false, 0)
            HabiticaIcons.drawItemIndicatorNumberDark(indicatorLocked: indicatorLocked, lockColor: lockColor, indicatorLockedDark: indicatorLockedDark, itemIndicatorColorBackground: itemIndicatorColorBackground)

        let imageOfItemIndicatorNumberDark = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @objc @IBOutlet dynamic var alertIconTargets: [AnyObject]! {
        get { return Cache.alertIconTargets }
        set {
            Cache.alertIconTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfAlertIcon)
            }
        }
    }

    @objc @IBOutlet dynamic var buffIconDarkTargets: [AnyObject]! {
        get { return Cache.buffIconDarkTargets }
        set {
            Cache.buffIconDarkTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfBuffIconDark)
            }
        }
    }

    @objc @IBOutlet dynamic var statsTargets: [AnyObject]! {
        get { return Cache.statsTargets }
        set {
            Cache.statsTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfStats)
            }
        }
    }

    @objc @IBOutlet dynamic var dashBorderTargets: [AnyObject]! {
        get { return Cache.dashBorderTargets }
        set {
            Cache.dashBorderTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfDashBorder)
            }
        }
    }

    @objc @IBOutlet dynamic var spookyGemPromoBGTargets: [AnyObject]! {
        get { return Cache.spookyGemPromoBGTargets }
        set {
            Cache.spookyGemPromoBGTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfSpookyGemPromoBG)
            }
        }
    }

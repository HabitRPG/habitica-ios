...
public class HabiticaIcons : NSObject {
    ...
    @objc dynamic public class func drawDifficultyStars(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 48, height: 12), resizing: ResizingBehavior = .aspectFit, difficulty: CGFloat = 3) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawTaskDifficultyStars(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 36, height: 36), resizing: ResizingBehavior = .aspectFit, taskTintColor: UIColor = UIColor(red: 0.380, green: 0.200, blue: 0.706, alpha: 1.000), difficulty: CGFloat = 3, isActive: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let isMedium = difficulty == 2
        let isHard = difficulty == 3
    ...
    @objc dynamic public class func drawTaskFormDifficultyStar(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 16, height: 16), resizing: ResizingBehavior = .aspectFit, taskTintColor: UIColor = UIColor(red: 0.380, green: 0.200, blue: 0.706, alpha: 1.000), isActive: Bool = false) {
        ...
        let borderColor = isActive ? transparent : strokeColor15
    ...
    @objc dynamic public class func imageOfDifficultyStars(difficulty: CGFloat = 3) -> UIImage {
    ...
    @objc dynamic public class func imageOfTaskDifficultyStars(taskTintColor: UIColor = UIColor(red: 0.380, green: 0.200, blue: 0.706, alpha: 1.000), difficulty: CGFloat = 3, isActive: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 36, height: 36), false, 0)

...
//  Habitica
//
//  Created by Phillip Thelen on 12.11.18.
...
public class HabiticaIcons : NSObject {
    ...
    @objc dynamic public class func drawItemIndicator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), isLocked: Bool = false, isLimited: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawItemIndicatorNumber(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000)) {
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, lockColor: lockColor, isLocked: false, isLimited: false)
        context.restoreGState()
    ...
    @objc dynamic public class func drawItemIndicatorLocked(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000)) {
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, lockColor: lockColor, isLocked: true, isLimited: false)
        context.restoreGState()
    ...
    @objc dynamic public class func drawItemIndicatorLimited(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000)) {
        ...
        HabiticaIcons.drawItemIndicator(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, lockColor: lockColor, isLocked: false, isLimited: true)
        context.restoreGState()

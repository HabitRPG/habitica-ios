...
//  Habitica
//
//  Created by Phillip Thelen on 31.08.20.
...
public class HabiticaIcons : NSObject {
    ...
    @objc dynamic public class func drawFallGemPromoBG(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 102, height: 35), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 102, height: 35), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 102, y: resizedFrame.height / 35)


        //// Color Declarations
        let strokeColor24 = UIColor(red: 1.000, green: 0.380, blue: 0.396, alpha: 1.000)
        let strokeColor25 = UIColor(red: 0.141, green: 0.800, blue: 0.561, alpha: 1.000)
        let strokeColor26 = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        let strokeColor27 = UIColor(red: 0.275, green: 0.655, blue: 0.851, alpha: 1.000)
        let strokeColor28 = UIColor(red: 0.573, green: 0.361, blue: 0.953, alpha: 1.000)
        ...
        //// Clip Clip 2
        let clip2Path = UIBezierPath()
        clip2Path.move(to: CGPoint(x: 80.54, y: 4.1))
        clip2Path.addLine(to: CGPoint(x: 80.05, y: 8.37))
        clip2Path.addLine(to: CGPoint(x: 85.26, y: 13.06))
        clip2Path.addLine(to: CGPoint(x: 89.46, y: 12.13))
        clip2Path.addLine(to: CGPoint(x: 89.35, y: 3.28))
        clip2Path.addLine(to: CGPoint(x: 80.54, y: 4.1))
        clip2Path.close()
        clip2Path.usesEvenOddFillRule = true
        clip2Path.addClip()
        ...
        //// Clip Clip
        let clipPath = UIBezierPath(rect: CGRect(x: 80, y: 3, width: 10, height: 11))
        clipPath.addClip()


        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 80.54, y: 4.1))
        bezierPath.addLine(to: CGPoint(x: 80.05, y: 8.37))
        bezierPath.addLine(to: CGPoint(x: 85.26, y: 13.06))
        bezierPath.addLine(to: CGPoint(x: 89.46, y: 12.13))
        bezierPath.addLine(to: CGPoint(x: 89.35, y: 3.28))
        bezierPath.addLine(to: CGPoint(x: 80.54, y: 4.1))
        bezierPath.close()
        strokeColor27.setStroke()
        bezierPath.lineWidth = 2
        ...
        clip4Path.move(to: CGPoint(x: 96.18, y: 29))
        clip4Path.addLine(to: CGPoint(x: 94.61, y: 25))
        clip4Path.addLine(to: CGPoint(x: 87.81, y: 23.3))
        clip4Path.addLine(to: CGPoint(x: 84.54, y: 26.09))
        clip4Path.addLine(to: CGPoint(x: 88.79, y: 33.85))
        clip4Path.addLine(to: CGPoint(x: 96.18, y: 29))
        clip4Path.close()
        ...
        //// Clip Clip 3
        let clip3Path = UIBezierPath(rect: CGRect(x: 84, y: 23, width: 13, height: 11))
        clip3Path.addClip()


        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 96.18, y: 29))
        bezier3Path.addLine(to: CGPoint(x: 94.61, y: 25))
        bezier3Path.addLine(to: CGPoint(x: 87.81, y: 23.3))
        bezier3Path.addLine(to: CGPoint(x: 84.54, y: 26.09))
        bezier3Path.addLine(to: CGPoint(x: 88.79, y: 33.85))
        bezier3Path.addLine(to: CGPoint(x: 96.18, y: 29))
        bezier3Path.close()
        strokeColor28.setStroke()
        bezier3Path.lineWidth = 2
        ...
        //// Bezier 5 Drawing
        let bezier5Path = UIBezierPath()
        bezier5Path.move(to: CGPoint(x: 79.08, y: 21.16))
        bezier5Path.addCurve(to: CGPoint(x: 77, y: 19), controlPoint1: CGPoint(x: 79.35, y: 19.51), controlPoint2: CGPoint(x: 78.65, y: 18.79))
        bezier5Path.addCurve(to: CGPoint(x: 74.92, y: 16.84), controlPoint1: CGPoint(x: 75.35, y: 19.21), controlPoint2: CGPoint(x: 74.65, y: 18.49))
        ...
        //// Bezier 6 Drawing
        let bezier6Path = UIBezierPath()
        bezier6Path.move(to: CGPoint(x: 99.02, y: 12.84))
        bezier6Path.addCurve(to: CGPoint(x: 100, y: 10), controlPoint1: CGPoint(x: 100.61, y: 12.33), controlPoint2: CGPoint(x: 100.94, y: 11.38))
        bezier6Path.addCurve(to: CGPoint(x: 100.98, y: 7.16), controlPoint1: CGPoint(x: 99.06, y: 8.62), controlPoint2: CGPoint(x: 99.39, y: 7.67))
        strokeColor26.setStroke()

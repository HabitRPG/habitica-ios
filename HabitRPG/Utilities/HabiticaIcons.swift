...
public class HabiticaIcons : NSObject {
    ...
    @objc dynamic public class func drawItemIndicator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 28, height: 28), resizing: ResizingBehavior = .aspectFit, lockColor: UIColor = UIColor(red: 0.765, green: 0.753, blue: 0.780, alpha: 1.000), isLocked: Bool = false, isLimited: Bool = false, isDark: Bool = true) {
        ...
        //// Variable Declarations
        let itemIndicatorColor = isLocked ? (isDark ? indicatorLockedDark : indicatorLocked) : (isLimited ? strokeColor : fillColor38)
    ...
    @objc dynamic public class func drawSpookyGemPromoBG(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 132, height: 35), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(rect: CGRect(x: -199, y: -765, width: 360, height: 1169))
        fillColor37.setFill()
        rectanglePath.fill()

...
public class HabiticaIcons : NSObject {
    ...
    private struct Cache {
        ...
        static var imageOfGuildHeaderCrest: UIImage?
        static var guildHeaderCrestTargets: [AnyObject]?
    ...
    @objc dynamic public class func drawGuildHeaderCrest(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 116, height: 58), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let fillColor19 = UIColor(red: 0.310, green: 0.165, blue: 0.576, alpha: 1.000)
        let fillColor96 = UIColor(red: 0.702, green: 0.537, blue: 1.000, alpha: 1.000)
        let fillColor97 = UIColor(red: 0.859, green: 0.776, blue: 1.000, alpha: 1.000)
        let strokeColor16 = UIColor(red: 0.604, green: 0.384, blue: 1.000, alpha: 1.000)
        let strokeColor17 = UIColor(red: 0.310, green: 0.165, blue: 0.576, alpha: 1.000)
        let fillColor98 = UIColor(red: 0.380, green: 0.200, blue: 0.706, alpha: 1.000)
        let fillColor99 = UIColor(red: 0.537, green: 0.400, blue: 0.780, alpha: 1.000)
        ...
        //// Bezier 13 Drawing
        let bezier13Path = UIBezierPath()
        bezier13Path.move(to: CGPoint(x: 58, y: 23.28))
        bezier13Path.addCurve(to: CGPoint(x: 50.5, y: 27.03), controlPoint1: CGPoint(x: 55.5, y: 23.28), controlPoint2: CGPoint(x: 50.5, y: 24.53))
        bezier13Path.addLine(to: CGPoint(x: 50.5, y: 29.7))
        bezier13Path.addLine(to: CGPoint(x: 65.5, y: 29.7))
        bezier13Path.addLine(to: CGPoint(x: 65.5, y: 27.03))
        bezier13Path.addCurve(to: CGPoint(x: 58, y: 23.28), controlPoint1: CGPoint(x: 65.5, y: 24.53), controlPoint2: CGPoint(x: 60.5, y: 23.28))
        bezier13Path.close()
        bezier13Path.move(to: CGPoint(x: 58, y: 14.7))
        bezier13Path.addCurve(to: CGPoint(x: 54.79, y: 17.92), controlPoint1: CGPoint(x: 56.23, y: 14.7), controlPoint2: CGPoint(x: 54.79, y: 16.14))
        bezier13Path.addCurve(to: CGPoint(x: 58, y: 21.13), controlPoint1: CGPoint(x: 54.79, y: 19.69), controlPoint2: CGPoint(x: 56.23, y: 21.13))
        bezier13Path.addCurve(to: CGPoint(x: 61.2, y: 17.92), controlPoint1: CGPoint(x: 59.78, y: 21.13), controlPoint2: CGPoint(x: 61.2, y: 19.69))
        bezier13Path.addCurve(to: CGPoint(x: 58, y: 14.7), controlPoint1: CGPoint(x: 61.2, y: 16.14), controlPoint2: CGPoint(x: 59.78, y: 14.7))
        bezier13Path.close()
        bezier13Path.usesEvenOddFillRule = true
        fillColor19.setFill()
        bezier13Path.fill()
        ...
        //// Bezier 15 Drawing
        let bezier15Path = UIBezierPath()
        bezier15Path.move(to: CGPoint(x: 57.77, y: 42.96))
        bezier15Path.addLine(to: CGPoint(x: 56.01, y: 43.9))
        bezier15Path.addCurve(to: CGPoint(x: 54.93, y: 43.13), controlPoint1: CGPoint(x: 55.28, y: 44.28), controlPoint2: CGPoint(x: 54.79, y: 43.93))
        bezier15Path.addLine(to: CGPoint(x: 55.27, y: 41.13))
        bezier15Path.addLine(to: CGPoint(x: 53.85, y: 39.73))
        bezier15Path.addCurve(to: CGPoint(x: 54.26, y: 38.46), controlPoint1: CGPoint(x: 53.25, y: 39.15), controlPoint2: CGPoint(x: 53.44, y: 38.58))
        bezier15Path.addLine(to: CGPoint(x: 56.22, y: 38.17))
        bezier15Path.addLine(to: CGPoint(x: 57.1, y: 36.37))
        bezier15Path.addCurve(to: CGPoint(x: 58.43, y: 36.37), controlPoint1: CGPoint(x: 57.47, y: 35.62), controlPoint2: CGPoint(x: 58.06, y: 35.62))
        bezier15Path.addLine(to: CGPoint(x: 59.31, y: 38.17))
        bezier15Path.addLine(to: CGPoint(x: 61.28, y: 38.46))
        bezier15Path.addCurve(to: CGPoint(x: 61.69, y: 39.73), controlPoint1: CGPoint(x: 62.1, y: 38.58), controlPoint2: CGPoint(x: 62.28, y: 39.15))
        bezier15Path.addLine(to: CGPoint(x: 60.26, y: 41.13))
        bezier15Path.addLine(to: CGPoint(x: 60.6, y: 43.13))
        bezier15Path.addCurve(to: CGPoint(x: 59.53, y: 43.9), controlPoint1: CGPoint(x: 60.74, y: 43.94), controlPoint2: CGPoint(x: 60.26, y: 44.28))
        bezier15Path.addLine(to: CGPoint(x: 57.77, y: 42.96))
        bezier15Path.close()
        bezier15Path.usesEvenOddFillRule = true
        fillColor19.setFill()
        bezier15Path.fill()
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 80, height: 80), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let textForeground3 = UIColor(red: 0.529, green: 0.506, blue: 0.565, alpha: 1.000)
        let strokeColor18 = UIColor(red: 0.306, green: 0.290, blue: 0.341, alpha: 1.000)

        //// Label Drawing
        let labelRect = CGRect(x: 26.12, y: 28, width: 29.09, height: 25)
        let labelTextContent = "Equip\nItem"
        let labelStyle = NSMutableParagraphStyle()
        labelStyle.alignment = .center
        let labelFontAttributes = [
        ...
        //// Clip Clip
        let clipPath = UIBezierPath(rect: CGRect(x: 10, y: 10, width: 60, height: 60))
        clipPath.addClip()


        //// Rectangle 3 Drawing
        let rectangle3Path = UIBezierPath(rect: CGRect(x: 10, y: 10, width: 60, height: 60))
    ...
    @objc dynamic public class var imageOfGuildHeaderCrest: UIImage {
        if Cache.imageOfGuildHeaderCrest != nil {
            return Cache.imageOfGuildHeaderCrest!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 116, height: 58), false, 0)
            HabiticaIcons.drawGuildHeaderCrest()

        Cache.imageOfGuildHeaderCrest = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @objc @IBOutlet dynamic var guildHeaderCrestTargets: [AnyObject]! {
        get { return Cache.guildHeaderCrestTargets }
        set {
            Cache.guildHeaderCrestTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfGuildHeaderCrest)
            }
        }
    }
    ...
    @objc @IBOutlet dynamic var canvas1Targets: [AnyObject]! {
        ...
        set {
            ...
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfCanvas1)
            }
        }
    }

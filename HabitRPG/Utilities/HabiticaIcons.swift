...
//  Habitica
//
//  Created by Phillip Thelen on 19.01.18.
...
public class HabiticaIcons : NSObject {
    ...
    private struct Cache {
        ...
        static var imageOfInfoIcon: UIImage?
        static var infoIconTargets: [AnyObject]?
    }
    ...
    @objc dynamic public class func drawDifficultyStars(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 48, height: 12), resizing: ResizingBehavior = .aspectFit, difficulty: CGFloat = 3.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawInfoIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 20, height: 20), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawQuestBackground(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 21, height: 21), resizing: ResizingBehavior = .aspectFit, bossColorDark: UIColor = UIColor(red: 0.764, green: 0.753, blue: 0.781, alpha: 1.000), bossColorMedium: UIColor = UIColor(red: 0.928, green: 0.925, blue: 0.935, alpha: 1.000), bossColorLight: UIColor = UIColor(red: 0.976, green: 0.977, blue: 0.976, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 21, height: 21))
        ...
        //// Group
        //// Rectangle 2 Drawing
        let rectangle2Path = UIBezierPath(rect: CGRect(x: 2, y: 13, width: 6, height: 6))
        bossColorLight.setFill()
        rectangle2Path.fill()


        //// Rectangle 3 Drawing
        let rectangle3Path = UIBezierPath(rect: CGRect(x: 4, y: 15, width: 2, height: 2))
        ...
        //// Group 2
        //// Rectangle 4 Drawing
        let rectangle4Path = UIBezierPath(rect: CGRect(x: 2, y: 2, width: 6, height: 6))
        bossColorLight.setFill()
        rectangle4Path.fill()


        //// Rectangle 5 Drawing
        let rectangle5Path = UIBezierPath(rect: CGRect(x: 4, y: 4, width: 2, height: 2))
        bossColorDark.setFill()
        rectangle5Path.fill()
        ...
        //// Group 3
        //// Rectangle 6 Drawing
        let rectangle6Path = UIBezierPath(rect: CGRect(x: 13, y: 2, width: 6, height: 6))
        bossColorLight.setFill()
        rectangle6Path.fill()


        //// Rectangle 7 Drawing
        let rectangle7Path = UIBezierPath(rect: CGRect(x: 15, y: 4, width: 2, height: 2))
        bossColorDark.setFill()
        rectangle7Path.fill()
        ...
        //// Group 4
        //// Rectangle 8 Drawing
        let rectangle8Path = UIBezierPath(rect: CGRect(x: 13, y: 13, width: 6, height: 6))
        bossColorLight.setFill()
        rectangle8Path.fill()


        //// Rectangle 9 Drawing
        let rectangle9Path = UIBezierPath(rect: CGRect(x: 15, y: 15, width: 2, height: 2))
        bossColorDark.setFill()
        rectangle9Path.fill()
        ...
        //// Rectangle 10 Drawing
        let rectangle10Path = UIBezierPath(rect: CGRect(x: 17, y: 10, width: 2, height: 1))
        bossColorLight.setFill()
        rectangle10Path.fill()


        //// Rectangle 11 Drawing
        let rectangle11Path = UIBezierPath(rect: CGRect(x: 10, y: 17, width: 1, height: 2))
        bossColorLight.setFill()
        rectangle11Path.fill()


        //// Rectangle 12 Drawing
        let rectangle12Path = UIBezierPath(rect: CGRect(x: 10, y: 2, width: 1, height: 2))
        bossColorLight.setFill()
        rectangle12Path.fill()


        //// Rectangle 13 Drawing
        let rectangle13Path = UIBezierPath(rect: CGRect(x: 10, y: 4, width: 1, height: 13))
        bossColorDark.setFill()
        rectangle13Path.fill()


        //// Rectangle 14 Drawing
        let rectangle14Path = UIBezierPath(rect: CGRect(x: 4, y: 10, width: 13, height: 1))
        bossColorDark.setFill()
        rectangle14Path.fill()


        //// Rectangle 15 Drawing
        let rectangle15Path = UIBezierPath(rect: CGRect(x: 2, y: 10, width: 2, height: 1))
        bossColorLight.setFill()
        rectangle15Path.fill()
    ...
    @objc dynamic public class func imageOfDifficultyStars(difficulty: CGFloat = 3.5) -> UIImage {
    ...
    @objc dynamic public class var imageOfInfoIcon: UIImage {
        if Cache.imageOfInfoIcon != nil {
            return Cache.imageOfInfoIcon!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 20, height: 20), false, 0)
            HabiticaIcons.drawInfoIcon()

        Cache.imageOfInfoIcon = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @objc dynamic public class func imageOfQuestBackground(bossColorDark: UIColor = UIColor(red: 0.764, green: 0.753, blue: 0.781, alpha: 1.000), bossColorMedium: UIColor = UIColor(red: 0.928, green: 0.925, blue: 0.935, alpha: 1.000), bossColorLight: UIColor = UIColor(red: 0.976, green: 0.977, blue: 0.976, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 21, height: 21), false, 0)
            HabiticaIcons.drawQuestBackground(bossColorDark: bossColorDark, bossColorMedium: bossColorMedium, bossColorLight: bossColorLight)
    ...
    @objc @IBOutlet dynamic var infoIconTargets: [AnyObject]! {
        get { return Cache.infoIconTargets }
        set {
            Cache.infoIconTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: HabiticaIcons.imageOfInfoIcon)
            }
        }
    }

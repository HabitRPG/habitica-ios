...
//  Habitica
//
//  Created by Phillip Thelen on 26.09.17.
...
public class HabiticaIcons : NSObject {
    ...
    @objc dynamic public class func drawHourglassShop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 42, height: 53), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 19.5, y: 0, width: 3, height: 10), cornerRadius: 1.4)
        fillColor18.setFill()
        rectanglePath.fill()
        ...
        //// Clip Clip
        let clipPath = UIBezierPath(roundedRect: CGRect(x: -5, y: -1.5, width: 10, height: 3), cornerRadius: 1.4)
        var clipTransformation = CGAffineTransform.identity
        clipTransformation = clipTransformation.translatedBy(x: 4, y: 10)
        ...
        //// Rectangle 2 Drawing
        context.saveGState()
        context.translateBy(x: 4, y: 10)
        context.rotate(by: 45 * CGFloat.pi/180)

        let rectangle2Path = UIBezierPath(rect: CGRect(x: -10, y: -6.5, width: 20, height: 13))
        fillColor18.setFill()
        rectangle2Path.fill()
        ...
        //// Clip Clip 2
        let clip2Path = UIBezierPath(roundedRect: CGRect(x: -5, y: -1.5, width: 10, height: 3), cornerRadius: 1.4)
        var clip2Transformation = CGAffineTransform.identity
        clip2Transformation = clip2Transformation.translatedBy(x: 37.1, y: 10)
        ...
        //// Rectangle 4 Drawing
        context.saveGState()
        context.translateBy(x: 37.1, y: 10)
        context.rotate(by: -45 * CGFloat.pi/180)

        let rectangle4Path = UIBezierPath(rect: CGRect(x: -10, y: -6.5, width: 20, height: 13))
        fillColor18.setFill()
        rectangle4Path.fill()
        ...
        bezier5Path.addCurve(to: CGPoint(x: 15.36, y: 43.54), controlPoint1: CGPoint(x: 17.05, y: 40.28), controlPoint2: CGPoint(x: 15.72, y: 41.62))
        ...
        bezier5Path.addCurve(to: CGPoint(x: 25.58, y: 42.65), controlPoint1: CGPoint(x: 24.32, y: 44.86), controlPoint2: CGPoint(x: 25.84, y: 43.77))

...
public class HabiticaIcons : NSObject {
    ...
    @objc dynamic public class func drawChatLikeIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 12, height: 12), resizing: ResizingBehavior = .aspectFit, wasLiked: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func imageOfChatLikeIcon(wasLiked: Bool = true) -> UIImage {

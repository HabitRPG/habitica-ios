...
+ (UIColor *)purple100 {
    return [UIColor colorWithRed:0.263 green:0.157 blue:0.455 alpha:1.000];
}
+ (UIColor *)purple200 {
    return [UIColor colorWithRed:0.310 green:0.165 blue:0.576 alpha:1.000];
}
+ (UIColor *)purple300 {
    return [UIColor colorWithRed:0.380 green:0.200 blue:0.706 alpha:1.000];
}
+ (UIColor *)purple400 {
    return [UIColor colorWithRed:0.604 green:0.384 blue:1.000 alpha:1.000];
}
+ (UIColor *)purple500 {
...
+ (UIColor *)yellow5 {
    return [UIColor colorWithRed:0.93 green:0.57 blue:0.04 alpha:1.0];
}
+ (UIColor *)yellow10 {

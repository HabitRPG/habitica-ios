...
- (void) pulseWithColor:(UIColor *)color {
    ...
    [UIView animateWithDuration:0.2 animations:^() {
        pulseView.frame = CGRectMake(pulseView.frame.origin.x-scaleWidth, pulseView.frame.origin.y-scaleHeight, pulseView.frame.size.width+(scaleWidth*2), pulseView.frame.size.height+(scaleHeight*2));
        pulseView.alpha = 0;

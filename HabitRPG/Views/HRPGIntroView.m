...
- (HRPGIntroView *)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        page1.desc = NSLocalizedString(@"Join over 900,000 people having fun while getting things "
                                       @"done. Create an avatar and track your real-life tasks.",
                                       nil);
        page1.descPositionY = titleposition - 24;
        page1.descFont = [UIFont systemFontOfSize:14.0];
        page1.titleIconView =
            [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"IntroPage1"]];
        ...
        page2.desc =
            NSLocalizedString(@"Unlock features in the game by checking off your real-life tasks. "
                              @"Earn armor, pets, and more to reward you for meeting your goals!",
                              nil);
        page2.descPositionY = titleposition - 24;
        page2.descFont = [UIFont systemFontOfSize:14.0];
        page2.titleIconView =
            [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"IntroPage2"]];
        ...
        page3.desc =
            NSLocalizedString(@"Keep your goals on track with help from your friends. Support each "
                              @"other in life and in battle as you improve together!",
                              nil);
        page3.descPositionY = titleposition - 24;
        page3.descFont = [UIFont systemFontOfSize:14.0];
        page3.titleIconView =
            [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"IntroPage3"]];

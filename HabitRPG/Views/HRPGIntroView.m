...
- (HRPGIntroView *)initWithFrame:(CGRect) frame {
    ...
    if (self) {
        ...
        page1.titleFont = [UIFont boldSystemFontOfSize:22.0];
        ...
        page1.titleFont = [UIFont boldSystemFontOfSize:16.0];
        page1.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"IntroPage1"]];
        page1.titleIconPositionY = titleposition - 180;
        ...
        page2.titleFont = [UIFont boldSystemFontOfSize:22.0];
        ...
        page2.titleFont = [UIFont boldSystemFontOfSize:16.0];
        page2.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"IntroPage2"]];
        page2.titleIconPositionY = titleposition - 240;
        ...
        page3.titleFont = [UIFont boldSystemFontOfSize:22.0];
        ...
        page3.titleFont = [UIFont boldSystemFontOfSize:16.0];
        page3.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"IntroPage3"]];
        page3.titleIconPositionY = titleposition - 150;
